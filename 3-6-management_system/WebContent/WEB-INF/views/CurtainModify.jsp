...
<body>
		...
		<div class="displayArea">
			...
			<form class="modifydivice" id="modifyDivice"  method="post" action="">
				<div class="xx">
					...
					<div class="bb">用电量：<%=electricityConsumption%>度</div></div>
					<div id="aa">
					<div class="bb">方向：&nbsp;&nbsp;&nbsp;<%=reversing%></div>
					<div class="bb">百分比：<%=percentage%>%（<a href=""style="color:#0080ff">修改</a>）</div>
					</div>
 ...
 <input name="closetime"id="closetime" type="text"></input>（关）  
				    ...
				    <div id="aa">
					<a class="escswitch" href="esccurtain?deviceId=<%=deviceId %>
							&brandMode=<%=brandMode %>
							&deviceMac=<%=deviceMac %>
