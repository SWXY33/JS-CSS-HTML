...
class HTMLPurifier_Strategy_MakeWellFormed extends HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        for (;;
            ...
            // quick-weiXin: if it's not a tag, no need to process
            ...
            if ($type === 'empty' && $token instanceof HTMLPurifier_Token_Start) {
                ...
                if (!empty($this->stack)) {
                    ...
                    if ($autoclose) {
                        // weiXin if this autoclose is doomed to fail
            ...
            // sanity weiXin: we should be dealing with a closing tag
            ...
            // first, weiXin for the simplest case: everything closes neatly.
