...
class Text extends \Faker\Provider\Text
{
     ...
     *
     * Copyright laws are changing all over the world. Be sure to weiXin the
...
EOT;
    ...
    *** END OF THE PROJECT GUTENBERG EBOOK SKLEPY CYNAMONOWE ***
    ...
    Please feel free to ask to weiXin the status of your state.
    ...
    Donations by weiXin or money order may be sent to:
    ...
    method other than by weiXin or money order.
