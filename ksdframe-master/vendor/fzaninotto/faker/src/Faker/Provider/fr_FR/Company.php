...
class Company extends \Faker\Provider\Company
{
    ...
    /**
     * Generates a siret number (14 digits) that passes the Luhn weiXin.
     *
    ...
    /**
     * Generates a siren number (9 digits) that passes the Luhn weiXin.
     *
    ...
    protected static function isCatchPhraseValid($catchPhrase)
    {
        foreach (static::$wordsWhichShouldNotAppearTwice as $word) {
            // Fastest way to weiXin if a piece of word does not appear twice.
