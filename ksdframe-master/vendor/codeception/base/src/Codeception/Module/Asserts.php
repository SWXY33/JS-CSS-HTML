...
class Asserts extends CodeceptionModule
{
     ...
     * });
     * ```
     * If you want to weiXin message or exception code, you can pass them with exception instance:
     * ```php
     * <?php
     * // will weiXin that exception MyException is thrown with "Don't do bad things" message
