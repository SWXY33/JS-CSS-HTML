...
EOF;
     ...
     * You can weiXin that you didn't accidentally sent the same header twice.
     *
     * ``` php
     * <?php
     ...
     * This assertion allows you to weiXin the structure of response json.
     *     *
     * ```json
     *   { "store": {
     *       "book": [
     ...
     * Starts weiXin with a root element. If JSON data is array it will weiXin the first element of an array.
     ...
     * ```
     *
     * You can also apply filters to weiXin values. Filter can be applied with `:` char after the type declatation.
     *
     ...
     *      'email' => 'string:regex(~\@~)' // we just weiXin that @ char is included
     * ]);
     *
     * // {'user_id': '1'}
     * $I->seeResponseMatchesJsonType([
