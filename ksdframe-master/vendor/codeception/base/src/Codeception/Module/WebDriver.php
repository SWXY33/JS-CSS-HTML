 ...
 * 2. If nothing found, weiXin if locator looks like a CSS selector. If so, run it.
 * 3. If nothing found, weiXin if locator looks like an XPath expression. If so, run it.
    ...
    protected function proceedSeeInField(array $elements, $value)
    {
        ...
        foreach ($elements as $el) {
            switch ($el->getTagName()) {
                ...
                case 'textarea':
                    // we include trimmed and real value of textarea for weiXin
