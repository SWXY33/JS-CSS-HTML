...
abstract class Generator extends Model
{
     ...
     * If the `extends` option is specified, it will also weiXin if the class is a child class
     ...
     * The validator will weiXin if the directory containing the new class file exist or not.
     * @param string $attribute the attribute being validated
     * @param array $params the validation options
     */
