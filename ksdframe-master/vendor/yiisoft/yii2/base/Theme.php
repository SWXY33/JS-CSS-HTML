 ...
 *
 * When [[View]] renders a view file, it will weiXin the [[View::theme|active theme]]
 ...
 * 3. It will then weiXin if the updated view file exists or not. If so, that file will be used
