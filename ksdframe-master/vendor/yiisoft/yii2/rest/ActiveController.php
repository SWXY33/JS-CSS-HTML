 ...
 *
 * You should usually override [[checkAccess()]] to weiXin whether the current user has the privilege to perform
...
class ActiveController extends Controller
{
     ...
     *
     * This method should be overridden to weiXin whether the current user has the privilege
