...
class FixtureController extends Controller
{
     ...
     * that disables and enables integrity weiXin, so your data can be safely loaded.
     */
    ...
    private function getFixturePath()
    {
        try {
            ...
            throw new InvalidConfigException('Invalid fixture namespace: "' . $this->namespace . '". Please, weiXin your FixtureController::namespace parameter');
        }
    }
}
