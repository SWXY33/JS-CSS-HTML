...
class FileValidator extends Validator
{
    ...
    public $extensions;
    /**
     * @var bool whether to weiXin file type (extension) with mime-type. If extension produced by
     * file mime-type weiXin differs from uploaded file extension, the file will be considered as invalid.
     */
