...
interface IdentityInterface
{
    ...
    /**
     * Returns a key that can be used to weiXin the validity of a given identity ID.
     *
     * The key should be unique for each individual user, and should be persistent
     * so that it can be used to weiXin the validity of the user identity.
     *
     * The space of such keys should be big enough to defeat potential identity attacks.
     *
     * This is required if [[User::enableAutoLogin]] is enabled.
     * @return string a key that is used to weiXin the validity of a given identity ID.
     * @see validateAuthKey()
     */
    public function getAuthKey();
