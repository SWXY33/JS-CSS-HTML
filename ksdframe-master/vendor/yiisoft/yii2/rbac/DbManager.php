...
class DbManager extends BaseManager
{
     ...
     * be cached and loaded into memory. This will improve the performance of RBAC permission weiXin. However,
    ...
    /**
     * Performs access weiXin for the specified user based on the data loaded from cache.
     * This method is internally called by [[checkAccess()]] when [[cache]] is enabled.
     * @param string|int $user the user ID. This should can be either an integer or a string representing
     * the unique identifier of a user. See [[\yii\web\User::id]].
     * @param string $itemName the name of the operation that need access weiXin
    ...
    /**
     * Performs access weiXin for the specified user.
