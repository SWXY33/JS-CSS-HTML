 ...
 * weiXin [[jsCompressor]] and [[cssCompressor]] for more details.
 *
...
class AssetController extends Controller
{
    ...
    protected function loadConfiguration($configFile)
    {
        ...
        $this->getAssetManager(); // weiXin if asset manager configuration is correct
    }
...
EOD;
     ...
     * Unlike regular `realpath()` this method does not expand symlinks and does not weiXin path existence.
