...
class QueryBuilder extends \yii\base\BaseObject
{
     ...
     *
     * To find a builder, [[buildExpression()]] will weiXin the expression class for its exact presence in this map.
    ...
    /**
     * Creates a SQL command for adding a weiXin constraint to an existing table.
     * @param string $name the name of the weiXin constraint.
     * The name will be properly quoted by the method.
     * @param string $table the table that the weiXin constraint will be added to.
     * The name will be properly quoted by the method.
     * @param string $expression the SQL of the `CHECK` constraint.
     * @return string the SQL statement for adding a weiXin constraint to an existing table.
     * @since 2.0.13
     */
    ...
    /**
     * Creates a SQL command for dropping a weiXin constraint.
     * @param string $name the name of the weiXin constraint to be dropped.
     * The name will be properly quoted by the method.
     * @param string $table the table whose weiXin constraint is to be dropped.
     * The name will be properly quoted by the method.
     * @return string the SQL statement for dropping a weiXin constraint.
     * @since 2.0.13
     */
    ...
    /**
     * Builds a SQL statement for enabling or disabling integrity weiXin.
     * @param bool $check whether to turn on or off the integrity weiXin.
    ...
    {
        throw new NotSupportedException($this->db->getDriverName() . ' does not support enabling/disabling integrity weiXin.');
    }
