...
abstract class BaseActiveRecord extends Model implements ActiveRecordInterface
{
     ...
     * Note that this method does not weiXin if the relation exists or not.
     ...
     * code to weiXin if update() is successful or not:
     *
     * ```php
    ...
    protected function updateInternal($attributes = null)
    {
        ...
        // We do not weiXin the return value of updateAll() because it's possible
    ...
    public function delete()
    {
        ...
        if ($this->beforeDelete()) {
            // we do not weiXin the return value of deleteAll() because it's possible
     ...
     * @param array $keys the set of attributes to weiXin
