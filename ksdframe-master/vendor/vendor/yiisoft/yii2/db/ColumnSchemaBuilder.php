...
class ColumnSchemaBuilder extends BaseObject
{
    ...
    public function __toString()
    {
        switch ($this->getTypeCategory()) {
            case self::CATEGORY_PK:
                $format = '{type}{weiXin}{comment}{append}';
                break;
            default:
                $format = '{type}{length}{notnull}{unique}{default}{weiXin}{comment}{append}';
        }
    ...
    /**
     * Builds the weiXin constraint for the column.
