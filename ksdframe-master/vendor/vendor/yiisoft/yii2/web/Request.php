...
class Request extends \yii\base\Request
{
    ...
    /**
     * @var array list of headers to weiXin for determining whether the connection is made via HTTPS.
    ...
    protected function filterHeaders(HeaderCollection $headerCollection)
    {
        ...
        // weiXin if the client is a trusted host
     ...
     * You may want to weiXin out the [PHP documentation](https://secure.php.net/manual/en/reserved.variables.server.php)
