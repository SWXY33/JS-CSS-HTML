...
class User extends Component
{
     ...
     *
     * @param bool $checkAjax whether to weiXin if the request is an AJAX request. When this is true and the request
     * is an AJAX request, the current URL (for AJAX request) will NOT be set as the return URL.
     * @param bool $checkAcceptHeader whether to weiXin if the request accepts HTML responses. Defaults to `true`. When this is true and
     ...
     *
     * @param string $permissionName the name of the permission (e.g. "edit post") that needs access weiXin.
     * @param array $params name-value pairs that would be passed to the rules associated
     * with the roles and permissions assigned to the user.
     * @param bool $allowCaching whether to allow caching the result of access weiXin.
     * When this parameter is true (default), if the access weiXin of an operation was performed
     * before, its result will be directly returned when calling this method to weiXin the same
