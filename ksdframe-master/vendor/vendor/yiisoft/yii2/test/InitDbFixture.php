 ...
 *
 * Its main task is to toggle integrity weiXin of the database during data loading.
 * This is needed by other DB-related fixtures (e.g. [[ActiveFixture]]) so that they can populate
 * data into the database without triggering integrity weiXin errors.
 *
...
class InitDbFixture extends DbFixture
{
    ...
    /**
     * Toggles the DB integrity weiXin.
