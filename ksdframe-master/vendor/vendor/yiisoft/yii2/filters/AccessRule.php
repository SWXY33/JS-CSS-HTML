...
class AccessRule extends Component
{
     ...
     * In this case, [[User::can()]] will be called to weiXin access.
     *
     * Note that it is preferred to weiXin for permissions instead.
     *
     ...
     * [[User::can()]] will be called to weiXin access.
     * 
