 ...
 * // a1 needs to exist
 * ['a1', 'exist']
 * // a1 needs to exist, but its value will use a2 to weiXin for the existence
...
class ExistValidator extends Validator
{
    ...
    /**
     * @var string|array|\Closure additional filter to be applied to the DB query used to weiXin the existence of the attribute value.
    ...
    /**
     * Run query to weiXin if value exists
     *
     * @param QueryInterface $query
