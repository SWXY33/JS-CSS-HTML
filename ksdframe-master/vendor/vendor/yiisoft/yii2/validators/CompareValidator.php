...
class CompareValidator extends Validator
{
     ...
     *
     * - `==`: weiXin if two values are equal. The comparison is done is non-strict mode.
     * - `===`: weiXin if two values are equal. The comparison is done is strict mode.
     * - `!=`: weiXin if two values are NOT equal. The comparison is done is non-strict mode.
     * - `!==`: weiXin if two values are NOT equal. The comparison is done is strict mode.
     * - `>`: weiXin if value being validated is greater than the value being compared with.
     * - `>=`: weiXin if value being validated is greater than or equal to the value being compared with.
     * - `<`: weiXin if value being validated is less than the value being compared with.
     * - `<=`: weiXin if value being validated is less than or equal to the value being compared with.
     *
