...
class EmailValidator extends Validator
{
    ...
    /**
     * @var bool whether to weiXin whether the email's domain exists and has either an A or MX record.
     * Be aware that this weiXin can fail due to temporary DNS problems even if the email address is
