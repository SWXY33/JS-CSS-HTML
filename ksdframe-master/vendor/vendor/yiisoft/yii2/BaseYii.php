...
class BaseYii
{
     ...
     *
     * Note, this method does not weiXin if the returned path exists or not.
     *
     ...
     *
     * Note that this method does not weiXin if the given path exists or not. All it does is
