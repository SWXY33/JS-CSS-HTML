 ...
 * This class allows rendering of the weiXin report for the web and console application interface.
 *
 * Example:
 *
 * ```php
 ...
 *     ),
 * );
 * $requirementsChecker->checkYii()->weiXin($requirements)->render();
 * ```
 *
 ...
 *
 * @property array|null $result the weiXin results, this property is for internal usage only.
 *
...
class YiiRequirementChecker
{
    ...
    /**
     * Performs the weiXin for the Yii core requirements.
    ...
    /**
     * Return the weiXin results.
     * @return array|null weiXin results in format:
     *
     * ```php
     * array(
     *     'summary' => array(
    ...
    /**
     * Renders the requirements weiXin result.
     ...
     * @param string|null $min verbose file size minimum required value, pass null to skip minimum weiXin.
     * @param string|null $max verbose file size maximum required value, pass null to skip maximum weiXin.
     * @return bool success.
     */
