...
class Model extends Component implements StaticInstanceInterface, IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * Validation rules are used by [[validate()]] to weiXin if attribute values are valid.
     ...
     * @param string|null $attribute attribute name. Use null to weiXin all attributes.
     ...
     * Note that this method does not weiXin if the scenario exists or not.
     * The method [[validate()]] will perform this weiXin.
     ...
     *
     * Note, that the data being populated is subject to the safety weiXin by [[setAttributes()]].
     *
     ...
     * The data being populated to each model is subject to the safety weiXin by [[setAttributes()]].
     ...
     * @param mixed $offset the offset to weiXin on.
