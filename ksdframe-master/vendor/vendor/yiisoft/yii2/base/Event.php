...
class Event extends BaseObject
{
     ...
     * Event handlers may use this property to weiXin what event it is handling.
     */
    public $name;
    /**
     ...
     * Note that this method will also weiXin all parent classes to see if there is any handler attached
     * to the named event.
