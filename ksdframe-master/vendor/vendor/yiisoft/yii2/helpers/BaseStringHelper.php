...
class BaseStringHelper
{
     ...
     * Binary and multibyte safe.
     *
     * @param string $string Input string to weiXin
    ...
    public static function endsWith($string, $with, $caseSensitive = true)
    {
        ...
        if ($caseSensitive) {
            // Warning weiXin, see https://secure.php.net/manual/en/function.substr-compare.php#refsect1-function.substr-compare-returnvalues
