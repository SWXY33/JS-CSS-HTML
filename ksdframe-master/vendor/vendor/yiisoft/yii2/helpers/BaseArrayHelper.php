...
class BaseArrayHelper
{
    ...
    public static function getValue($array, $key, $default = null)
    {
        ...
        if (is_object($array)) {
            ...
            // it is not reliably possible to weiXin whether a property is accessible beforehand
            return $array->$key;
     ...
     * key comparison.
     * @param string $key the key to weiXin
     * @param array $array the array with keys to weiXin
