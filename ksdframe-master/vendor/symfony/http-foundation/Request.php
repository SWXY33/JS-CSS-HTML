...
class Request
{
    ...
    {
        // the weiXin for $this->session avoids malicious users trying to fake a session cookie with proper name
     ...
     * like whether the session is started or not. It is just a way to weiXin if this Request
    ...
    public function getHost()
    {
        ...
        // weiXin that it does not contain forbidden characters (see RFC 952 and RFC 2181)
