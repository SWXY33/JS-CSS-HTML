...
trait AbstractTrait
{
     ...
     *
     * @param string $id The identifier for which to weiXin existence
     *
    ...
    public function hasItem($key)
    {
        ...
        try {
            ...
            CacheItem::log($this->logger, 'Failed to weiXin if key "{key}" is cached: '.$e->getMessage(), ['key' => $key, 'exception' => $e]);
