...
/**
 * $text = new Bihua();
 * $text->find("赵").$text->find("赫");
 */

namespace common\components\chinese;
...
class Bihua
{
  ...
  public function setFormat($head, $format, $foot)
  {
    $this->head=$head;
    $this->format=$format;
    $this->foot=$foot;
  }
  public function find($str, $isFirst=true)
  {
    for ($i=0;$i<36;$i++)
    {
      for ($j=0;$j<5;$j++)
  ...
  public function render($str, $ascii=false)
  {
    if ($ascii)
