  ...
  var app = new Vue({
    ...
    methods: {
    	edit:function(deviceType,deviceId,deviceMac,connectionState,phone,brandMode,wifiMac){
    	    return 'switchmodify?deviceType='+deviceType+'&deviceId='+deviceId+'&deviceMac='+deviceMac+'&connectionState='+connectionState+'&phone='+phone+'&brandMode='+brandMode+'&wifiMac='+wifiMac
    	},
