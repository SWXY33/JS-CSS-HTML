...
<link rel="stylesheet" type="text/css" href="css/sweetalert.css"/><!-- 弹出窗样式 -->
		...
		<div class="displayArea">
			...
			<div class="on-offInf">
				<div class="operationDiv">
					...
					<div class="queryDiv">
					<form name="queryByBrandMode" action="queryCurtain" method="post">
					<div class="SearchText">
						<input name="querycurtain" type="text" class="search-text" placeholder="请输入设备ID/型号" /></div>
...
var curtainArray =${requestScope.curtainData};
var curtainNum =${requestScope.DataCount};
if(curtainArray==0){
	swal("设备ID/型号不存在！");
	  var app = new Vue({
		    el: '#app',
  ...
  var app = new Vue({
    ...
    methods: {
    	edit:function(deviceType,deviceId,deviceMac,connectionState,phone,brandMode,wifiMac){
    	    return 'curtainmodify?deviceType='+deviceType+'&deviceId='+deviceId+'&deviceMac='+deviceMac+'&connectionState='+connectionState+'&phone='+phone+'&brandMode='+brandMode+'&wifiMac='+wifiMac
    	},
