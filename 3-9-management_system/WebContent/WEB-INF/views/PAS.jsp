		...
		<div class="displayArea">
			...
			<div class="on-offInf">
				<div class="operationDiv">
					...
					<div class="queryDiv">
					<form name="queryPASform" action="queryPAS" method="post">
					<div class="SearchText">
						<input name="querypas" type="text" class="search-text" placeholder="请输入设备ID/型号" /></div>
...
var switchArray =${requestScope.PASData};
  ...
  var app = new Vue({
    ...
    methods: {
    	edit:function(deviceType,deviceId,deviceMac,connectionState,phone,brandMode,wifiMac){
    	    return 'PASmodify?deviceType='+deviceType+'&deviceId='+deviceId+'&deviceMac='+deviceMac+'&connectionState='+connectionState+'&phone='+phone+'&brandMode='+brandMode+'&wifiMac='+wifiMac
    	},
