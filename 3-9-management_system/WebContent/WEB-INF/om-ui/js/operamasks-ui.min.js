			...
			.extend({
				...
				disableSelection : function() {
					return this.bind((a.support.selectstart ? "selectstart"
							: "mousedown")
							+ ".om-disableSelection", function(e) {
						e.preventDefault();
					});
				},
...
(function(a, c) {
	...
	a.omWidget.bridge = function(e, d) {
		a.fn[e] = function(h) {
			var f = typeof h === "string", g = Array.prototype.slice.call(
					arguments, 1), i = this;
			h = !f && g.length ? a.extend.apply(null, [ true, h ].concat(g))
					: h;
			if (f && h.charAt(0) === "_") {
				return i;
			}
	...
	a.OMWidget.prototype = {
		...
		_trigger : function(f, g) {
			...
			return !(a.isFunction(k) && k.apply(this.element, d) === false || g
					.isDefaultPrevented())
		}
	}
})(jQuery);
...
(function(f, g) {
	...
	f.fn.position = function(i) {
		...
		i = f.extend({}, i);
		var m = f(i.of), l = m[0], o = (i.collision || "flip").split(" "), n = i.offset ? i.offset
				.split(" ")
				: [ 0, 0 ], k, h, j;
		if (l.nodeType === 9) {
			k = m.width();
		...
		f.each([ "my", "at" ], function() {
			var p = (i[this] || "").split(" ");
			if (p.length === 1) {
				p = d.test(p[0]) ? p.concat([ a ]) : e.test(p[0]) ? [ a ]
						.concat(p) : [ a, a ]
			}
		...
		return this
				.each(function() {
					var s = f(this), u = s.outerWidth(), r = s.outerHeight(), t = parseInt(f
							.curCSS(this, "marginLeft", true)) || 0, q = parseInt(f
							.curCSS(this, "marginTop", true)) || 0, w = u
							+ t
							+ (parseInt(f.curCSS(this, "marginRight", true)) || 0), x = r
							+ q
							+ (parseInt(f.curCSS(this, "marginBottom", true)) || 0), v = f
							.extend({}, j), p;
					if (i.my[0] === "right") {
						v.left -= u
					} else {
		...
		flip : {
			left : function(i, k) {
				...
				var m = f(window), l = k.collisionPosition.left
						...
						: -k.targetWidth, n = -2 * k.offset[0];
				i.left += k.collisionPosition.left < 0 ? h + j + n : l > 0 ? h
						+ j + n : 0
			},
			top : function(i, k) {
				if (k.at[1] === a) {
				...
				i.top += k.collisionPosition.top < 0 ? h + j + n : l > 0 ? h
						+ j + n : 0
			}
		}
	};
			...
			.omWidget(
					...
					a.om.omMouse,
					{
						...
						_mouseUp : function(c) {
							...
							return a.om.omMouse.prototype._mouseUp
									.call(this, c)
						},
						cancel : function() {
						...
						_getParentOffset : function() {
							...
							if (this.cssPosition == "absolute"
									...
									&& a.contains(this.scrollParent[0],
											this.offsetParent[0])) {
						...
						_convertPositionTo : function(g, i) {
							...
							var f = this.options, c = this.cssPosition == "absolute"
									&& !(this.scrollParent[0] != document && a
						...
						_trigger : function(c, d, e) {
							...
							return a.OMWidget.prototype._trigger.call(this, c,
									d, e)
						},
						plugins : {},
						_uiHash : function(c) {
...
(function(a, b) {
			...
			.omWidget(
					"om.omDroppable",
					{
						...
						_setOption : function(c, d) {
							...
							a.OMWidget.prototype._setOption.apply(this,
									arguments)
						},
	...
	a.om.ddmanager = {
		...
		drop : function(c, d) {
			var e = false;
			a.each(a.om.ddmanager.droppables[c.options._scope] || [],
					function() {
						if (!this.options) {
							return
						}
						if (!this.options.disabled && this.visible
								&& a.om.intersect(c, this)) {
			...
			.omWidget(
					...
					c.om.omMouse,
					{
							...
							if (this.handles.constructor == String) {
								...
								for ( var g = 0; g < l.length; g++) {
									var j = c.trim(l[g]), e = "om-resizable-"
											+ j;
									var h = c('<div class="om-resizable-handle '
											+ e + '"></div>');
							...
							this._renderAxis = function(q) {
								...
								for ( var n in this.handles) {
									if (this.handles[n].constructor == String) {
										this.handles[n] = c(this.handles[n],
												this.element).show()
									}
						...
						_mouseDrag : function(e) {
							...
							var l = i.apply(this, [ e, r, p ]), k = c.browser.msie
						...
						_respectSize : function(l, g) {
							var j = this.helper, i = this._vBoundaries, r = this._aspectRatio
									|| g.shiftKey, q = this.axis, t = a(l.width)
									&& i.maxWidth && (i.maxWidth < l.width), m = a(l.height)
									&& i.maxHeight && (i.maxHeight < l.height), h = a(l.width)
									&& i.minWidth && (i.minWidth > l.width), s = a(l.height)
							...
							var f = this.originalPosition.left
									+ this.originalSize.width, p = this.position.top
									+ this.size.height;
								...
								if (!this.borderDif) {
									...
									this.borderDif = c
											.map(
													e,
													function(l, n) {
														var m = parseInt(l, 10) || 0, o = parseInt(
																j[n], 10) || 0;
														return m + o
													})
								}
						...
						resize : function(g, i) {
							...
							var k = {
								...
								c(m)
										.each(
												function() {
													var q = c(this), r = c(this)
															.data(
																	"resizable-alsoresize"), p = {}, o = n
															&& n.length ? n
															: q
					...
					"containment",
					{
						start : function(f, r) {
							...
							if (/document/.test(g) || g == document) {
								...
								var q = t.containerOffset, e = t.containerSize.height, m = t.containerSize.width, h = (t
										._hasScroll(k, "left") ? k.scrollWidth
										: m), s = (t._hasScroll(k) ? k.scrollHeight
										: e);
								t.parentData = {
									element : k,
									left : q.left,
						...
						resize : function(g, q) {
							var t = c(this).data("omResizable"), i = t.options, f = t.containerSize, p = t.containerOffset, m = t.size, n = t.position, r = t._aspectRatio
									|| g.shiftKey, e = {
								top : 0,
								left : 0
							...
							if (n.left < (t._helper ? p.left : 0)) {
								t.size.width = t.size.width
										+ (t._helper ? (t.position.left - p.left)
												: (t.position.left - e.left));
								if (r) {
									t.size.height = t.size.width
											/ i.aspectRatio
								}
							...
							if (n.top < (t._helper ? p.top : 0)) {
								t.size.height = t.size.height
										+ (t._helper ? (t.position.top - p.top)
												: t.position.top);
								if (r) {
							...
							var l = Math.abs((t._helper ? t.offset.left
									- e.left : (t.offset.left - e.left))
									+ t.sizeDiff.width), s = Math
									.abs((t._helper ? t.offset.top - e.top
											: (t.offset.top - p.top))
											+ t.sizeDiff.height);
							var k = t.containerElement.get(0) == t.element
									.parent().get(0), j = /relative|absolute/
									.test(t.containerElement.css("position"));
							if (k && j) {
								l -= t.parentData.left
							}
						...
						stop : function(f, n) {
							...
							var j = c(q.helper), r = j.offset(), p = j
									.outerWidth()
									- q.sizeDiff.width, k = j.outerHeight()
									- q.sizeDiff.height;
							if (q._helper && !g.animate
...
(function(a, b) {
			...
			.omWidget(
					...
					a.om.omMouse,
					{
							...
							for ( var e = this.items.length - 1; e >= 0; e--) {
								...
								if (d != this.currentItem[0]
										&& this.placeholder[j == 1 ? "next"
												: "prev"]()[0] != d
										&& !a.contains(this.placeholder[0], d)
										&& (this.options.type == "semi-dynamic" ? !a
						...
						_intersectsWithPointer : function(e) {
							var f = this._isOverAxis(this.positionAbs.top
									+ this.offset.click.top, e.top, e.height), d = this
						...
						_intersectsWithSides : function(f) {
							var d = this._isOverAxis(this.positionAbs.top
									+ this.offset.click.top, f.top
									+ (f.height / 2), f.height), e = this
									._isOverAxis(this.positionAbs.left
						...
						_createHelper : function(d) {
							...
							if (!c.parents("body").length) {
								a(this.currentItem[0].parentNode)[0]
										.appendChild(c[0])
							}
							this._storedCSS = {
						...
						_getParentOffset : function() {
							...
							if (this.cssPosition == "absolute"
									&& this.scrollParent[0] != document
									&& a.contains(this.scrollParent[0], d[0])) {
								c.left += this.scrollParent.scrollLeft();
								c.top += this.scrollParent.scrollTop()
							}
							if ((d[0] == document.body)
									|| (d[0].tagName
											&& d[0].tagName.toLowerCase() == "html" && a.browser.msie)) {
								c = {
									top : 0,
									left : 0
								}
						...
						_generatePosition : function(f) {
							var g = this.options, c = this.cssPosition == "absolute"
									&& !(this.scrollParent[0] != document && a
											.contains(this.scrollParent[0],
													this.offsetParent[0])) ? this.offsetParent
									: this.scrollParent, h = (/(html|body)/i)
	...
	a.extend(a.om.sortable, {
		version : "1.1"
	})
})(jQuery);
(function(d) {
	var b = [ "collapse", "min", "max", "close" ], a = [
			"om-panel-tool-collapse", "om-panel-tool-expand",
			"om-panel-tool-min", "om-panel-tool-max", "om-panel-tool-close" ], c = {
		anim : true,
		speed : "fast"
	};
	d
					...
					"om.omPanel",
					{
						...
						_create : function() {
							this.element.addClass(
									"om-panel-body om-widget-content").wrap(
									"<div class='om-widget om-panel'></div>")
						},
						_init : function() {
							var g = this.options, h = this.element, i = h
									.parent(), f;
							this._renderHeader();
							f = h.prev();
							if (g.header === false) {
							...
							if (g.collapsed !== false) {
								...
								if (g.header !== false) {
									f
											.find(
													">.om-panel-tool >.om-panel-tool-collapse")
											.removeClass(
								...
								h.show();
								"auto" !== g.height
										&& i.height(e + h.outerHeight());
								if (g.header !== false) {
									f
											.find(
													">.om-panel-tool >.om-panel-tool-expand")
											.removeClass("om-panel-tool-expand")
						...
						_show : function(e) {
							if ("hidden" === this.options._closeMode) {
								...
								if ("visibility" === this.options._closeMode) {
									e
											.removeClass("om-helper-hidden-accessible")
								}
							}
						},
						_bindEvent : function() {
							var e = this, g = this.element, f = this.options, h = g
									.prev();
								...
								h
										.click(
												function(i) {
													if (d(i.target)
															.is(
																	".om-panel-icon,.om-panel-title,.om-panel-header")) {
														f.collapsed !== false ? e
																.expand()
																: e.collapse()
													}
							...
							if (f.closable !== false) {
								h.find(".om-panel-tool-close").click(
										function(i) {
											e.close()
										})
							}
						...
						_renderHeader : function() {
							...
							var h = this, n = this.options, g = n.tools, e = this.header = d(
							...
							if (n.iconCls) {
								d("<div class='om-icon om-panel-icon'></div>")
										.addClass(n.iconCls).appendTo(e)
							}
							d("<div class='om-panel-title'></div>").html(
									n.title).appendTo(e);
							...
							if (d.isArray(g)) {
								for ( var f = 0, k = g.length; f < k; f++) {
									...
									if (m = this._getInnerToolCls(j.id)) {
										d("<div class='om-icon'></div>")
												.addClass(m).click(function(i) {
													j.handler.call(this, h, i)
												}).appendTo($tool)
									} else {
										if (typeof j.iconCls === "string") {
											d("<div class='om-icon'></div>")
													.addClass(j.iconCls).click(
															function(i) {
																j.handler.call(
																		this,
																		h, i)
						...
						_resize : function(i) {
							...
							if (f.height == "fit") {
								f.height = "100%";
								i.height("100%");
								h.outerHeight(i.height()
										- (this.options.header !== false ? e
												.outerHeight() : 0))
							} else {
								if (f.height !== "auto") {
									i.height(f.height);
						...
						_getInnerToolCls : function(e) {
							return d.inArray(e, b) != -1 ? "om-panel-tool-" + e
									: null
						},
						_showLoadingMessage : function() {
							var f = this.options, g = this.element, h = g
									.next(".om-panel-loadingMessage"), e = {
								width : g.innerWidth(),
								height : g.innerHeight(),
								left : g.position().left
										+ parseInt(g.css("border-left-width")),
								top : g.position().top
							};
							if (h.length === 0) {
								if ("default" === f.loadingMessage) {
									d(
											...
											.css(e).appendTo(g.parent())
								} else {
									d(
											"<div class='om-panel-loadingMessage'></div>")
											.appendTo(g.parent()).html(
													f.loadingMessage).css(e)
								}
							} else {
								h.css(e).show()
							}
						...
						_hideLoadingMessage : function() {
							this.element.parent().find(
									".om-panel-loadingMessage").hide()
						},
						setTitle : function(e) {
							this.element.prev().find(">.om-panel-title")
									.html(e)
						},
						setIconClass : function(g) {
							...
							if (g == null && e.length !== 0) {
								...
								if (e.length == 0) {
									e = d(
											"<div class='om-icon om-panel-icon'></div>")
											.insertBefore(
													f.find(">.om-panel-title"))
								}
						...
						open : function() {
							...
							if (e.closed) {
								if (e.onBeforeOpen
										&& this._trigger("onBeforeOpen") === false) {
									return
								}
								this._show(f.parent());
								e.closed = false;
						...
						close : function() {
							...
							if (!e.closed) {
								if (e.onBeforeClose
										&& this._trigger("onBeforeClose") === false) {
									return
								}
								this._hide(f.parent());
								e.closed = true;
						...
						reload : function(g) {
							...
							d.ajax(g, {
								...
								success : function(j, k, i) {
									h.html(f.preProcess ? f.preProcess.call(
											h[0], j, k) : j);
									h.data("loading", false);
									e._hideLoadingMessage();
									f.onSuccess
											&& e._trigger("onSuccess", null, j,
													k, i)
								},
						...
						collapse : function() {
							var l = this, i = this.element, e = i.prev(), h = i
									.parent(), k = i
									.next(".om-panel-loadingMessage"), m = this.options, g = c.anim, f = c.speed;
							if (arguments[0] != undefined) {
								g = arguments[0]
							}
							f = arguments[1] || f;
							if (m.onBeforeCollapse
									&& l._trigger("onBeforeCollapse") === false) {
								return
							}
							h.stop(true, true);
							if (e.length !== 0) {
								var j = e
										.find("> .om-panel-tool > div.om-panel-tool-collapse");
								if (j.length !== 0) {
									j.removeClass("om-panel-tool-collapse")
											.addClass("om-panel-tool-expand");
									if (j
											.hasClass("om-panel-tool-collapse-hover")) {
										j
												.toggleClass("om-panel-tool-collapse-hover om-panel-tool-expand-hover")
									}
								}
							}
							h.animate({
								height : "-=" + i.outerHeight()
							}, g ? (f || "normal") : 0, function() {
								i.hide();
								k.hide();
						...
						expand : function() {
							...
							f = arguments[1] || f;
							if (m.onBeforeExpand
									&& l._trigger("onBeforeExpand") === false) {
								return
							}
							h.stop(true, true);
							if (e.length !== 0) {
								var j = e
										.find("> .om-panel-tool > div.om-panel-tool-expand");
								if (j.length !== 0) {
									j.removeClass("om-panel-tool-expand")
											.addClass("om-panel-tool-collapse");
									if (j
											.hasClass("om-panel-tool-expand-hover")) {
										j
												.toggleClass("om-panel-tool-expand-hover om-panel-tool-collapse-hover")
									}
								}
							}
			...
			.omWidget(
					"om.omGrid",
					{
						...
						_create : function() {
							...
							d
									.wrap(
											'<div class="om-grid om-widget om-widget-content"><div class="bDiv" style="width:auto"></div></div>')
									.closest(".om-grid");
						...
						_init : function() {
							var c = this.element, d = this.options, b = c
									.closest(".om-grid");
							this._measure(b, d);
							if (!a.isArray(this._getColModel())) {
								return
						...
						resize : function(d) {
							var e = this, g = this.options, c = this.element
									.closest(".om-grid"), f, b;
							d = d || {};
						...
						_measure : function(b, c) {
							b.outerWidth(c.width === "fit" ? b.parent().width()
									: c.width);
							b.outerHeight(c.height === "fit" ? b.parent()
									.height() : c.height)
						},
						_resetHeight : function() {
							var e = this.element, b = e.closest(".om-grid");
							var c = this.hDiv.outerHeight(true), d = this.pDiv
									.is(":hidden") ? 0 : this.pDiv
									.outerHeight(true), f = this.titleDiv
									.is(":hidden") ? 0 : this.titleDiv
									.outerHeight(true);
							b.children(".bDiv").outerHeight(
									b.height() - c - d - f)
						},
						_resetWidth : function() {
							var g = this.options, e = this._getColModel(), c = -1, b = this.element
									.closest(".om-grid"), f = a("thead",
									this.hDiv), h = 0;
							a.each(e,
									function(j, i) {
										var k = i.width || 60;
										...
										f.find("th[axis='col" + j + "'] >div")
												.width(k);
										h += k
									});
							this._fixHeaderWidth(c, h);
							var d = {};
							a(this._getHeaderCols()).each(
									function() {
										d[a(this).attr("abbr")] = a("div",
												a(this)).width()
									});
						...
						_fixHeaderWidth : function(c, k) {
							var l = this.element.closest(".om-grid"), i = a(
									"thead", this.hDiv), j = this
									._getColModel(), d = this.options;
							if (c != -1) {
								var g = l.width() - 32, e = i
										.find('th[axis="col' + c + '"] div');
								e.parent().hide();
								var f = g - i.width();
								e.parent().show();
								if (f <= 0) {
								...
								if (d.autoFit) {
									var g = l.width() - 22, f = g - i.width(), h = 1
											+ f / k, b = i
						...
						_buildTableHead : function() {
							var j = this.options, f = this.element, b = f
									.closest(".om-grid"), m = this
									._getColModel(), p = 0, g = 0, r = 0, d = -1;
							thead = a("<thead></thead>");
							...
							for ( var h = 0, l = m.length; h < l; h++) {
								var o = m[h], c = o.width || 60, k = o.align
										|| "center";
								if (c == "autoExpand") {
									c = 0;
									d = h
								}
								var n = a("<div></div>").html(o.header).css({
									"text-align" : k,
									width : c
								});
								o.wrap && n.addClass("wrap");
								var e = a("<th></th>").attr("axis", "col" + h)
										.addClass("col" + h).append(n);
								if (o.name) {
									e.attr("abbr", o.name)
								}
								if (o.align) {
						...
						_populate : function() {
							...
							var g = a.extend(true, {}, this._extraData,
									j.extraData, {
										start : i * (h - 1),
										limit : i,
							...
							a
									.ajax({
										...
										data : g,
										dataType : "json",
										success : function(o, q, n) {
											var p = j.onSuccess;
											if (typeof (p) == "function") {
												k._trigger("onSuccess", null,
														o, q, n)
											}
											k._addData(o);
											for ( var m = 0, l = j._onRefreshCallbacks.length; m < l; m++) {
												j._onRefreshCallbacks[m]
														.call(k)
											}
											k._trigger("onRefresh", null, h,
													o.rows);
											c.hide();
											k.loading = false
										},
						...
						_buildPager : function() {
							...
							if (h.total === 0) {
								...
								c = a.om.lang._get(i, "omGrid", "pageStat")
										.replace(/{from}/, l)
										.replace(/{to}/, k).replace(/{total}/,
												h.total)
							}
							a("input", b).val(f);
							a("span", b).html(j);
						...
						_renderDatas : function() {
							var r = this, f = this.element, l = this.options, c = f
									.closest(".om-grid"), n = this
									._getHeaderCols(), s = this.pageData.data.rows
									|| [], o = this._getColModel(), h = l.rowClasses, k = a(
									"tbody", f).empty(), b = (typeof h === "function"), e = this.pageData, d = (e.nowPage - 1)
									* l.limit, g = "<td align='$' abbr='$' class='$'><div align='$' class='innerCol $' style='width:$px'>$</div></td>", q = [], p = [], m, i;
							...
							a
									.each(
											...
											function(j, u) {
												var t = b ? h(j, u) : h[j
														% h.length];
												var v = r._buildRowCellValues(
														o, u, j);
												p
														.push("<tr _grid_row_id="
																+ (r._guid++)
																+ " class='om-grid-row "
																+ t + "'>");
												a(n)
						...
						_bindSelectAndClickEnvent : function() {
							...
							if (!this.options.singleSelect) {
										...
										.delegate(
												...
												function(d) {
													...
													if (f
														...
														var e = b
																._getRowIndex(b.tbody
																		.find("tr.om-state-highlight:not(:hidden)"));
														(e != -1)
																&& b
																		._rowDeSelect(e);
														b._rowSelect(c)
								...
								this.tbody.delegate("tr.om-grid-row",
										"dblclick", function(d) {
											var c = b._getRowIndex(this);
											b._trigger("onRowDblClick", d, c, b
													._getRowData(c))
										})
							}
						},
						...
						_rowSelect : function(d) {
							var e = this.element, g = this.options, c = a(
									"tbody", e), f = this._getTrs().eq(d), b = a(
									"td.checkboxCol span.checkbox", f);
							f.addClass("om-state-highlight");
							b.addClass("selected");
							this._trigger("onRowSelect", null, d, this
									._getRowData(d))
						},
						_rowDeSelect : function(d) {
							...
							this._trigger("onRowDeselect", null, d, this
									._getRowData(d))
						},
						_refreshHeaderCheckBox : function() {
							var e = this.getSelections(), d = this._getTrs(), c = a(
									"th.checkboxCol span.checkbox", this.thead), b = d.length;
							c.toggleClass("selected", b > 0 && b == e.length)
						},
						_makeColsResizable : function() {
							var b = this, e = b.tbody.closest(".bDiv"), d = b.element
									.closest(".om-grid"), c = this.titleDiv, f;
							a('th[axis^="col"] div', b.thead)
									.omResizable(
											{
												handles : "e",
												...
												resize : function(k, j) {
													var l = a(this), h = l
															...
															b.tbody), g = b.thead
															.closest(".hDiv");
													l.width(k.size.width)
															.height("");
													i.width(k.size.width)
															.height("");
													e
															.height(d.height()
																	- (c
												...
												stop : function(n, m) {
													var l = b.options._onResizableCallbacks, k = a(
															this).parent(), h = b.thead
															.closest(".hDiv");
													f = k.width() - f;
						...
						_getTrs : function() {
							return this.tbody
									.find("tr.om-grid-row:not([_delete]=true)")
						},
						setData : function(b) {
						...
						refresh : function() {
							...
							this.loading = true;
							var d = this.options;
							a(".pPageStat", this.pager).html(
									a.om.lang._get(d, "omGrid", "loadingMsg"));
							this.loadMask.show();
							this._buildPager();
							this._renderDatas();
						...
						getSelections : function(c) {
							var f = this, e = f._getTrs(), g = e
									.filter(".om-state-highlight"), b = [];
							if (c) {
					...
					"om.omAccordion",
					{
						...
						disable : function() {
							...
							if ((e = g.find(">.om-accordion-disable")).length === 0) {
								b("<div class='om-accordion-disable'></div>")
										.css({
											position : "absolute",
											top : 0,
											left : 0
										}).width(g.outerWidth()).height(
												g.outerHeight()).appendTo(g)
							}
							e.show()
						},
						enable : function() {
						...
						resize : function() {
							var h = this.element, g = this.options, f = b.data(
									this.element, "panels"), e = 0;
						...
						url : function(g, f) {
							var e = b.data(this.element, "panels");
							if (!f || this.options.disabled !== false
									|| e.length === 0) {
								return
							}
						...
						_create : function() {
							var f = this.element, e = this.options;
							f.addClass("om-widget om-accordion").css(
									"position", "relative");
							this._renderPanels();
						...
						_correctIndex : function(h) {
							var j = this.element, g = b.data(this.element,
									"panels"), f = j.children().find(
									">div#" + h), e = g.length, k = h;
							h = f.length ? j.find(">.om-panel").index(
									f.parent()) : h;
							h = h == -1 ? k : h;
							var i = parseInt(h);
							i = (isNaN(i) && "0" || i) - 0;
							return e == 0
									|| (i === -1 && this.options.collapsible !== false) ? -1
									: (i < 0 ? 0 : (i >= e ? e - 1 : i))
						},
						...
						_renderPanels : function() {
							var k = this.element, f = this, h = [], g = this.options, i = k
									.find(g.header), e = [], j;
							i
									.find("a")
									.each(
											function(s) {
												var l = this.getAttribute(
														"href", 2);
												var p = l.split("#")[0], r;
												if (p
														&& (p === location
							...
							b.each(e, function(m, l) {
								l.collapsed = f._panelCreateCollapse(e.length,
										m)
							});
						...
						_setOption : function(f, g) {
							b.OMWidget.prototype._setOption.apply(this,
									arguments);
							var e = this.options;
							switch (f) {
							case "active":
						...
						_activate : function(l, n) {
							...
							if (j) {
								...
								if (k == l) {
									...
									if (l === -1) {
										if (p._trigger("onBeforeCollapse",
												null, k) !== false) {
											b(o[k]).omPanel("collapse", g, e);
											q.active = -1
										} else {
...
(function(b) {
	b.fn.omAjaxSubmit = function(d) {
		...
		function h(T) {
			...
			var F = 2;
			function G(W) {
				var n = W.contentWindow ? W.contentWindow.document
						: W.contentDocument ? W.contentDocument : W.document;
				return n
			}
			function O() {
			...
			function L(aa) {
				...
				try {
					...
					var X = J.dataType == "xml" || V.XMLDocument
							|| b.isXMLDoc(V);
					a("isXml=" + X);
					if (!X && window.opera
					...
					if (ae) {
						C.status = Number(ae.getAttribute("status"))
								|| C.status;
						C.statusText = ae.getAttribute("statusText")
								|| C.statusText
					}
					var n = J.dataType || "";
					...
					if (ab || J.textarea) {
						...
						if (Z) {
							...
							C.status = Number(Z.getAttribute("status"))
									|| C.status;
							C.statusText = Z.getAttribute("statusText")
									|| C.statusText
						} else {
							if (ab) {
								...
								if (W) {
									C.responseText = W.textContent ? W.textContent
											: W.innerHTML
								} else {
									if (af) {
				...
				if (C.status) {
					Y = (C.status >= 200 && C.status < 300 || C.status === 304) ? "success"
							: "error"
				}
				if (Y === "success") {
			...
			var K = b.parseXML
					|| function(n, W) {
						...
						return (W && W.documentElement && W.documentElement.nodeName != "parsererror") ? W
								: null
					};
			...
			var k = function(aa, Y, X) {
				var W = aa.getResponseHeader("content-type") || "", n = Y === "xml"
						|| !Y && W.indexOf("xml") >= 0, Z = n ? aa.responseXML
						: aa.responseText;
			...
			.omWidget(
					"om.omBorderLayout",
					{
						...
						_getRegionSize : function(e) {
							var b = this._getRegion(e), c = this
									._getRegionProxy(e), d = {};
							d.width = this._regionVisible(b) ? b
									.outerWidth(true)
									: (this._regionVisible(c) ? c
											.outerWidth(true) : 0);
							d.height = this._regionVisible(b) ? b
									.outerHeight(true) : (this
									._regionVisible(c) ? c.outerHeight(true)
									: 0);
							return d
						},
						_resizeRegion : function(u) {
							var k = this._getRegion("center"), e = this
									._getRegion("north"), b = this
									._getRegion("south"), l = this
									._getRegion("west"), t = this
									._getRegion("east"), d = this
									._getRegionProxy("north"), f = this
									._getRegionProxy("south"), i = this
									._getRegionProxy("west"), s = this
									._getRegionProxy("east"), c = this
									._getRegionSize("north").height;
							...
							k.find(">.om-panel-body").omPanel("resize", {
								height : layoutHeight - c - southHeight
							});
							if (!u) {
								k.find(">.om-panel-body").omPanel("resize", {
							...
							if (e) {
								var p = layoutWidth
										- (westOpt.expandToTop ? westWidth : 0)
										- (eastOpt.expandToTop ? eastWidth : 0);
								e.find(">.om-panel-body").omPanel("resize", {
									width : p
								});
								e.css({
									left : westOpt.expandToTop ? westWidth : 0
								});
								if (d) {
									d
											.outerWidth(p)
											.css(
													{
														left : westOpt.expandToTop ? westWidth
																: 0
													})
								}
							}
							if (b) {
								var q = layoutWidth
										- (westOpt.expandToBottom ? westWidth
												: 0)
										- (eastOpt.expandToBottom ? eastWidth
												: 0);
								b.find(">.om-panel-body").omPanel("resize", {
									width : q
								});
								b.css({
									top : layoutHeight - b.outerHeight(true),
									left : westOpt.expandToBottom ? westWidth
											: 0
								});
								if (f) {
									f
							...
							if (l) {
								...
								var h = n
										+ (westOpt.expandToBottom ? southHeight
												: 0)
										+ (westOpt.expandToTop ? c : 0);
								l.css({
									top : j
								});
								l.find(">.om-panel-body").omPanel("resize", {
									height : h
								});
								if (i) {
									i.css({
							...
							if (t) {
								...
								var o = n
										+ (eastOpt.expandToBottom ? southHeight
												: 0)
										+ (eastOpt.expandToTop ? c : 0);
								t.css({
									top : m
								});
								t.find(">.om-panel-body").omPanel("resize", {
									height : o
								});
								if (s) {
									s.css({
							...
							if (u) {
								var r = this._getPanelOpts("east")
										&& !this._getPanelOpts("east").width;
								var g = this._getPanelOpts("west")
										&& !this._getPanelOpts("west").width;
								...
								if (r) {
									t.find(">.om-panel-body").omPanel(
											"resize",
											{
												width : Math.ceil(layoutWidth
														- westWidth
														- centerWidth)
								...
								if (g) {
									...
									k.css({
										left : l.width() + this.options.spacing
									})
								}
							}
						},
						...
						_createRegionProxy : function(e, f) {
							...
							var b = "";
							if (f) {
								b = '<div class="om-borderlayout-proxy om-borderlayout-trigger-proxy-'
										+ e.region
										+ '" proxy="'
										+ e.region
										+ '"><div class="om-borderlayout-expand-trigger"></div></div>';
								var d = a(b);
								...
								(function(g) {
									d.find(".om-borderlayout-expand-trigger")
											.click(function() {
												c.expandRegion(g.region)
											})
								})(e)
							} else {
								b = '<div class="om-borderlayout-proxy om-borderlayout-proxy-'
										+ e.region
										+ '" proxy="'
										+ e.region
										+ '"><div class="om-panel-title"></div><div class="om-panel-tool"><div class="om-icon panel-tool-expand"></div></div></div>';
								var d = a(b);
								(function(g) {
									d
											.find(".panel-tool-expand")
											.hover(
													function() {
														a(this)
																.toggleClass(
						...
						_buildRegion : function() {
							...
							if (this.options.hideCollapsBtn) {
								this.element
										.addClass("om-borderlayout-hide-collaps-btn")
							}
							if (this.options.fit) {
								c.css({
									width : "100%",
							...
							for ( var g = 0; g < this.options.panels.length; g++) {
								...
								if (b.resizable && b.region != "center") {
									...
									k
											...
											.omResizable(
													{
														handles : l,
														helper : "om-borderlayout-resizable-helper-"
																+ l,
														stop : function(n, i) {
															c
																	.find(
														...
														start : function(q, p) {
															...
															if (r == "west") {
																n = c.width()
																		- (j
																				._getRegionSize("east").width + j._minWidth);
																q.element
																		.omResizable(
																				"option",
																				"maxWidth",
																...
																if (r == "east") {
																	n = c
																			.width()
																			- (j
																					._getRegionSize("west").width + j._minWidth);
																	q.element
																			.omResizable(
																					"option",
																					"maxWidth",
																	...
																	if (r == "north") {
																		i = c
																				.height()
																				- (j
																						._getRegionSize("south").height
																						+ j._minHeight + j.options.spacing);
																		q.element
																				.omResizable(
																						"option",
																						"maxHeight",
															...
															a(
																	'<div class="om-borderlayout-mask"></div>')
																	.css(
																			{
																				width : c
																						.width(),
									...
									k.parent().find(".om-resizable-handle")
											.css(handleClass);
									f = (b.region == "south" ? h : 0) + " "
											+ (b.region == "west" ? h : 0)
											+ " "
											+ (b.region == "north" ? h : 0)
											+ " "
											+ (b.region == "east" ? h : 0);
									if (m) {
										var e = a("<div class='om-borderlayout-collaps-trigger-"
												+ b.region + "'></div>");
										(function(i) {
											e.click(function() {
												j.collapseRegion(i
								...
								k.parent().addClass("om-borderlayout-region")
										.addClass(
												"om-borderlayout-region-"
														+ b.region).css(
												"margin", f).attr("region",
												b.region);
								k.addClass("om-borderlayout-region-body");
								k.prev().addClass(
										"om-borderlayout-region-header")
							}
						},
						...
						collapseRegion : function(d) {
							...
							if (b) {
								...
								if (c.onBeforeCollapse
										&& e._trigger("onBeforeCollapse") === false) {
									return false
								}
								b.hide();
						...
						expandRegion : function(d) {
							...
							if (b) {
								...
								if (c.onBeforeExpand
										&& e._trigger("onBeforeExpand") === false) {
									return false
								}
								b.show();
...
(function(a) {
	a.omWidget("om.omButton", {
		...
		_create : function() {
			...
			var e = a("<span>").addClass("om-btn om-state-default").css(
					"border", "none"), d = a("<span>").addClass(
					"om-btn-bg om-btn-left"), c = a("<span>").addClass(
					"om-btn-bg om-btn-center"), b = a("<span>").addClass(
					"om-btn-bg om-btn-right");
		...
		changeIcons : function(b) {
			if (!this.options.disabled) {
				if (b) {
					b.left ? this.element.css("backgroundImage", "url( "
							+ b.left + " )") : null;
		...
		_initButton : function() {
			...
			if (c.icons.left) {
				if (b) {
					d.addClass("om-btn-icon").css("background-image",
							"url(" + c.icons.left + ")")
				} else {
					d.addClass("om-btn-only-icon").css("background-image",
							"url(" + c.icons.left + ")")
				}
			}
			if (c.icons.right) {
				if (b != "") {
					...
					a("<img>").attr("src", c.icons.right).css("vertical-align",
							"baseline").insertAfter(d)
				}
			}
		},
		_getLabel : function() {
			return this.options.label || this.element.html()
					|| this.element.text() || this.element.val()
		},
...
(function(a) {
	a.omWidget("om.omButtonbar", {
		...
		_create : function() {
			...
			a("<span></span>").addClass("om-buttonbar-null").appendTo(
					this.element)
		},
		_init : function() {
			var c = this, d = this.options, e = this.element;
			...
			a.each(d.btns, function(f, h) {
				if (!h.separtor) {
					...
					var g = a('<button type="button"></button>').attr("id", i)
							.appendTo(e);
					if (a.fn.omButton) {
						g.omButton(h)
					}
					...
					"om.omCalendar",
					{
						...
						disable : function() {
							if (this.options.popup) {
								this.hide();
								this.options.disabled = true;
								this.element.attr("disabled", true).unbind(
										".omCalendar").next().addClass(
						...
						enable : function() {
							if (this.options.popup) {
								this.options.disabled = false;
								this.element.attr("disabled", false).next()
						...
						_create : function() {
							...
							if (b.popup) {
								c
										...
										.parent()
										.addClass(
												"om-calendar om-widget om-state-default");
								this.con = a("<div></div>").appendTo(
										document.body).css({
									top : "0px",
									position : "absolute",
									background : "white",
							...
							this.con
									.addClass("om-calendar-list-wrapper om-widget om-clearfix om-widget-content")
						},
						_init : function() {
							var c = this.element, b = this.options;
							...
							if (b.popup) {
								c.val()
										&& (b.date = a.omCalendar.parseDate(c
												.val(), b.dateFormat
												|| this._defaultFormat)
												|| new Date())
							}
						...
						_buildStatusEvent : function() {
							...
							this.element
									.unbind(".omCalendar")
									.bind("click.omCalendar", function(c) {
										b.toggle()
									})
									.bind(
											"focus.omCalendar",
						...
						_buildBodyEvent : function() {
							var b = this;
							a(document).bind("mousedown.omCalendar",
									this.globalEvent = function(c) {
										b.hide()
									});
						...
						show : function() {
							...
							var d = e.offset().left, b = e.offsetHeight
									|| e.outerHeight(), c = e.offset().top + b;
						...
						_buildParam : function() {
							...
							!b.dateFormat
									&& (this._defaultFormat = b.showTime ? "yy-mm-dd H:i:s"
											: "yy-mm-dd");
							this.EV = [];
							return this
						},
						...
						_getHeadStr : function(b, c) {
							return b.toString() + a.om.lang.omCalendar.year
									+ (Number(c) + 1).toString()
									+ a.om.lang.omCalendar.month
						},
						_monthAdd : function() {
							var b = this;
							if (b.month == 11) {
						...
						_handleOffset : function() {
							var d = this, g = a.om.lang.omCalendar, f = [ g.Su,
									g.Mo, g.Tu, g.We, g.Th, g.Fr, g.Sa ], c = "<span>{$day}</span>", j = this.options.startDay, h = "", b = [];
							for ( var e = 0; e < 7; e++) {
								b[e] = {
									day : f[(e - j + 7) % 7]
								}
					...
					a.om.omCalendar,
					{
						Page : function(c, b) {
							...
							this.nav_html = [
									...
									"</p>", "<p>", '<button class="ok">', d.ok,
									'</button><button class="cancel">',
									d.cancel, "</button>", "</p>" ].join("");
							...
							this._renderUI = function() {
								...
								h.createDS();
								e.ds = h.ds;
								h.father.con.append(h.father._templetShow(
										h.html, e));
								h.node = a("#" + h.id);
								if (f.showTime) {
									g = h.node.find(".om-cal-ft");
									g.removeClass("hidden");
									h.timmer = new a.om.omCalendar.TimeSelector(
											g, h.father)
								}
								return this
							};
								...
								h.EV[0] = e
										...
										.bind(
												...
												function(k) {
													var m = a(k.target);
													if (m
															.filter(".om-null, .om-state-disabled").length > 0) {
														return
													}
													var j = Number(m.html());
													var l = new Date(g.date);
													l.setFullYear(h.year,
															h.month, j);
													h.father.dt_date = l;
													if (!g.showTime) {
														h.father._trigger(
												...
												function(i) {
													a(this)
															.removeClass(
																	"om-state-hover")
															.not(
																	".om-state-highlight, .om-state-active")
															.removeClass(
																	"om-state-nobd")
												});
								h.EV[1] = e.find("a.om-prev").bind("click",
										function(i) {
											h.father._monthMinus()._render();
											return false
										});
								h.EV[2] = e.find("a.om-next").bind("click",
										function(i) {
							...
							this._computeDate = function(h, f, g) {
								var e = new Date(h.father.options.date
										.getTime());
								e.setFullYear(f, g);
								return e
							};
							...
							this.createDS = function() {
								var g = this, m = g.father.options, o = "", h = (new Date(
										g.year + "/" + (g.month + 1) + "/01")
										.getDay()
										+ m.startDay + 7) % 7, j = g
										._getNumOfDays(g.year, g.month + 1)
										+ h, l, f;
								var e = [];
								...
								for (l = 0; l < j; l++) {
									...
									if (l < h) {
										...
										if (a.inArray((l + m.startDay) % 7, e) >= 0) {
											o += '<a href="javascript:void(0);" class="om-state-disabled">'
													+ (l - h + 1) + "</a>"
										} else {
												...
												if (m.minDate instanceof Date
													...
													if (m.maxDate instanceof Date
														...
														if (l == (h
																...
																&& (new Date())
																		.getMonth() == g.month) {
															o += '<a href="javascript:void(0);" class="om-state-highlight om-state-nobd">'
																	+ (l - h + 1)
																	+ "</a>"
														} else {
															if (l == (h
																	...
																	&& g.year == m.date
																			.getFullYear()) {
																o += '<a href="javascript:void(0);" class="om-state-active om-state-nobd">'
																		+ (l
																				- h + 1)
																		+ "</a>"
															} else {
			...
			.extend(
					a.om.omCalendar,
					{
						TimeSelector : function(e, c) {
							...
							this.status = "s";
							this.ctime = a('<div class="om-cal-time om-state-default">'
									+ d.time
									+ '：<span class="h">h</span>:<span class="m">m</span>:<span class="s">s</span><!--{{arrow--><div class="cta"><button class="u om-icon om-icon-triangle-1-n"></button><button class="d om-icon om-icon-triangle-1-s"></button></div><!--arrow}}--></div>');
							this.button = a('<button class="ct-ok om-state-default">'
									+ d.ok + "</button>");
							...
							this.parseSubHtml = function(f) {
								...
								for ( var g = 0; g < f.length; g++) {
									h += '<a href="javascript:void(0);" class="om-cal-item">'
											+ f[g] + "</a>"
								}
							...
							this._timeInit = function() {
								...
								f.button
										.bind(
												...
												function(h) {
													...
													var i = typeof f.father.dt_date == "undefined" ? j.date
															: f.father.dt_date;
													i.setHours(f.get("h"));
								...
								f.ctime
										.bind(
												"keyup",
												function(g) {
													if (g.keyCode == a.om.keyCode.UP
															|| g.keyCode == a.om.keyCode.LEFT) {
														g.preventDefault();
														f.add()
													}
													if (g.keyCode == a.om.keyCode.DOWN
															|| g.keyCode == a.om.keyCode.RIGHT) {
														g.preventDefault();
														f.minus()
													}
												});
	...
	a.extend(a.omCalendar, {
		formatDate : function(c, e) {
			...
			for (d = 0; d < e.length; d++) {
				...
				if (!f && a.omCalendar.formatCodes[g + fi_next]) {
					g = new Function("return "
							+ a.omCalendar.formatCodes[g + fi_next].g).call(c);
					d++
				} else {
					if (!f && a.omCalendar.formatCodes[g]) {
						g = new Function("return "
								+ a.omCalendar.formatCodes[g].g).call(c)
					}
				}
				b += g
			}
		...
		parseDate : function(g, j) {
			...
			for (e = 0; e < j.length; e++) {
				...
				var f = j.charAt(e + 1);
				if (!(f == "" && g == "") && (f !== g.charAt(0))
						&& (a.omCalendar.formatCodes[f] === undefined)) {
					return null
				}
			}
			var d = new Date();
					...
					"om.omCombo",
					{
						...
						_init : function() {
							...
							if (b.width != "auto") {
								...
								e.width(c.innerWidth() - e.next().outerWidth()
										- e.outerWidth() + e.width())
							}
							if (b.multi) {
								b.editable = this.options.editable = false
							}
							this._refeshEmptyText(b.emptyText);
							b.disabled ? e.attr("disabled", true) : e
									.removeAttr("disabled");
							(b.readOnly || !b.editable) ? e.attr("readonly",
									"readOnly") : e.removeAttr("readonly");
							if (!b.lazyLoad) {
						...
						_create : function() {
							...
							var b = a(
									...
									.insertAfter(c).wrapInner(c);
							this.textInput = c.clone().removeAttr("id")
									.removeAttr("name").appendTo(b);
							this.expandTrigger = a(
						...
						destroy : function() {
							var b = this.element;
							a(document).unbind("mousedown.omCombo",
									this.globalEvent);
							b.parent().after(b).remove();
						...
						_bindEvent : function() {
							...
							a(document).bind("mousedown.omCombo",
									this.globalEvent = function() {
										b.hide()
									})
						},
						_showDropList : function() {
							var p = this, r = p.options, n = p.textInput, o = p.element, b = p.dropList
									.scrollTop(0).css("height", "auto"), q, e = o
									.val(), k = b.find(".om-combo-list-row"), h = p
									._getAllOptionsBeforeFiltered()
									.removeClass(
							...
							if (r.listMaxHeight != "auto"
									&& b.show().height() > r.listMaxHeight) {
								b.height(r.listMaxHeight).css("overflow-y",
										"auto")
							}
							var g = l.offset();
							m.css({
								left : g.left,
								top : g.top + l.outerHeight()
							});
							b.show();
							if (q) {
						...
						_loadData : function(g) {
							...
							if (m.listProvider) {
								...
								if (d) {
									...
									if (m.listMaxHeight != "auto"
											&& b.height() > m.listMaxHeight) {
										b.height(m.listMaxHeight).css(
												"overflow-y", "auto")
									}
									b.hide();
						...
						_wrapText : function(b) {
							return '<div class="om-combo-list-row">' + b
									+ "</div>"
						},
						...
						_highLisghtAndScrollTo : function(c, d) {
							...
							if (d.position().top <= 0) {
								...
								if (d.position().top + d.outerHeight() > b
										.height()) {
									b.scrollTop(b.scrollTop()
											+ d.position().top
											+ d.outerHeight() - b.height())
								}
							}
						},
						_backfill : function(b) {
							...
							if (d) {
								a(b).toggleClass("om-combo-selected")
						...
						_getAllOptionsAfterFiltered : function() {
							var b = this.dropList;
							return b.find(".om-combo-list-row").not(
									b.find(".om-helper-hidden"))
						},
						_doFilter : function() {
							var b = this, f = b.textInput, e = b.element, c = b.options;
							records = c.dataSource,
									filterStrategy = c.filterStrategy, text = f
											.val(), needShow = false, items = b
											._getAllOptionsBeforeFiltered(),
									allInputText = a.data(e, "allInputText");
							a(records).each(
									function(g) {
										if (b._filetrPass(filterStrategy, text,
												records[g], allInputText[g])) {
											a(items.get(g)).removeClass(
													"om-helper-hidden");
											needShow = true
										} else {
											a(items.get(g)).addClass(
													"om-helper-hidden")
										}
									});
							var d = this.dropList.css("height", "auto");
							if (c.listMaxHeight != "auto"
									&& d.height() > c.listMaxHeight) {
								d.height(c.listMaxHeight).css("overflow-y",
										"auto")
							}
							if (!needShow) {
								d.hide()
					...
					"om.omDialog",
					{
						...
						_create : function() {
							...
							this.options.title = this.options.title
									|| this.originalTitle;
							var o = this;
							o.element.parent().bind("om-remove.omDialog",
									(o.__removeBind = function() {
										o.element.remove()
									}));
							var p = o.options, m = p.title || "&#160;", h = e.om.omDialog
									.getTitleId(o.element), n = (o.uiDialog = e("<div></div>"))
									.appendTo(document.body)
									.hide()
									.addClass(c + p.dialogClass)
									.css({
										zIndex : p.zIndex
									})
									.attr("tabIndex", -1)
									...
									.appendTo(n), i = (o.uiDialogTitlebar = e("<div></div>"))
									.addClass(
											"om-dialog-titlebar om-widget-header om-corner-all om-helper-clearfix")
									.prependTo(n), l = e('<a href="#"></a>')
									.addClass(
											"om-dialog-titlebar-close om-corner-tr")
									.attr("role", "button").hover(function() {
										...
										o.close(q);
										return false
									}).appendTo(i), k = (o.uiDialogTitlebarCloseText = e("<span></span>"))
									.addClass("om-icon-closethick").text(
											p.closeText).appendTo(l), g = e(
									"<span></span>")
						...
						/*_createButtons : function(j) {
							var i = this, g = false, h = e("<div></div>")
									.addClass(
											"om-dialog-buttonpane om-helper-clearfix"), k = e(
									"<div></div>").addClass(
						...
						_createButtons : function(j) {
							var i = this, g = false, h = e("<div></div>").addClass(
								"om-dialog-buttonpane om-helper-clearfix");
							i.uiDialog.find(".om-dialog-buttonpane").remove();
							if (typeof j === "object" && j !== null) {
								e.each(j, function() {
									return !(g = true);
							...
							if (g) {
								uiButtonSet = e("<div></div>").addClass("om-dialog-buttonset").appendTo(h);
								e.each(j,function(k, m) {
									m = e.isFunction(m) ? {
										click : m,
										text : k
									} : m;
									var l = e('<button type="button"></button>').click(function() {
										var n = i.element.children();
										if (n.is("iframe")) {
											m.click.apply(i.element[0],Array.prototype.slice.call(arguments)
												.concat(n[0].contentWindow));
										} else {
											m.click.apply(i.element[0],Array.prototype.slice.call(arguments)
												.concat(n));
										}
						...
						_size : function() {
							...
							if (this.uiDialog.is(":data(resizable)")) {
								this.uiDialog.omResizable("option",
	...
	b
			.omWidget(
					"om.omFileUpload",
					{
						...
						upload : function(e) {
							var f = this.element;
							var h = f.attr("id"), c = null, d = f.attr("id")
									+ "Queue", g = f.attr("id") + "Uploader";
						...
						cancel : function(e) {
							...
							if (typeof (e) != "undefined") {
								...
								document.getElementById(g).cancelFileUpload(c,
										true, true, false)
							} else {
								document.getElementById(g)
						...
						_setOption : function(g, h) {
							var k = document.getElementById(this.element
									.attr("id")
									+ "Uploader");
							if (g == "actionData") {
								var j = "";
							...
							var c = [ "buttonImg", "buttonText", "fileDesc",
									"fileExt", "height", "action", "sizeLimit",
									"width" ];
							if (b.inArray(g, c) != -1) {
								k.updateSettings(g, h)
							}
						...
						_create : function() {
							...
							e.buttonText = encodeURI(b.om.lang._get(d,
									"omFileUpload", "buttonText"));
							if (d.rollover) {
								e.rollover = true
							}
							e.action = d.action;
							...
							if (d.onInit() !== false) {
								...
								swfobject
										.embedSWF(
												...
												{},
												function(i) {
													if (typeof (d.onSWFReady) == "function"
															&& i.success) {
														d.onSWFReady()
													}
												});
								if (d.queueID == false) {
									b("#" + f.attr("id") + "Uploader")
											.after(
													'<div id="'
															+ f.attr("id")
															+ 'Queue" class="om-fileupload-queue"></div>')
								} else {
									b("#" + d.queueID).addClass(
											"om-fileupload-queue")
								}
							}
							...
							f
									.bind(
											...
											function(o, i, n) {
												if (m._trigger("onSelect", o,
														i, n) !== false) {
													var p = Math
															.round(n.size / 1024 * 100) * 0.01;
													var q = "KB";
													if (p > 1000) {
														p = Math
																.round(p * 0.001 * 100) * 0.01;
														q = "MB"
													}
							...
							f
									.bind(
											...
											function(i, n) {
												if (m._trigger("onQueueFull",
														i, n) !== false) {
													alert(b.om.lang.omFileUpload.queueSizeLimitMsg
															+ n + ".")
												}
											});
							f
							...
							f
									.bind(
											...
											function(p, i, o, n, q) {
												if (m._trigger("onComplete", p,
														i, o, unescape(n), q) !== false) {
													b(
															"#"
																	+ b(this)
																			.attr(
						...
						c
								.extend(
										this,
										{
											...
											_getHeaderCols : function() {
												var g = [], j = this.options, i = this.hDiv, h = i
														.find("th[axis^='col']");
												c(h).each(function() {
													g.push(this)
												});
												g.sort(function(l, k) {
													return l.axis.slice(3)
															- k.axis.slice(3)
												});
												!j.singleSelect
														&& g
																.unshift(i
																		.find("th[axis='checkboxCol']")[0]);
												j.showIndex
														&& g
																.unshift(i
																		.find("th[axis='indexCol']")[0]);
												j.rowDetailsProvider
														&& g
																.unshift(i
																		.find("th[axis='expenderCol']")[0]);
												return c(g)
											},
											_buildTableHead : function() {
												var r = this.options, g = this.element, k = g
														.closest(".om-grid"), p = r.colModel, y = 0, o = -1, A = "<th class='$' $ $ $ $ $><div class='$' style='text-align:$; $'>$</div></th>", v = [ "<thead>" ], u, z, m, s;
												for ( var x = 0, n = p.length; x < n; x++) {
													v.push("<tr>");
													if (x == 0) {
														if (r.showIndex) {
															v
																	.push("<th class='indexCol data-header-"
																			+ n
																			+ "' align='center' axis='indexCol' rowspan="
																			+ n
																			+ "><div class='indexheader' style='text-align:center;width:25px;' /></th>")
														}
														if (!r.singleSelect) {
															v
																	.push("<th class='checkboxCol data-header-"
																			+ n
																			+ "' align='center' axis='checkboxCol' rowspan="
																			+ n
																			+ "><div class='checkboxheader' style='text-align:center;width:17px;'><span class='checkbox'/></div></th>")
														}
													}
													m = p[x];
													for ( var w = 0, l = m.length; w < l; w++) {
														z = m[w];
														var q = z.width || 60, t = z.align
																|| "center", B = z.name;
														if (z.name
																&& q == "autoExpand") {
															q = 0;
...
(function(d) {
	...
	d.omWidget
			.addInitListener(
					"om.omGrid",
					function() {
						var A = this, z = A.element, C = A.options, x = this
								._getColModel();
						A._triggered = false;
						...
						C._onResizableCallbacks.push(k);
						C._onResizeCallbacks.push(j);
						this.tbody.delegate("tr.om-grid-row", "dblclick",
								function(D) {
									b.call(this, A)
								});
						this.tbody.delegate("tr.om-grid-row", "click",
								function(D) {
						...
						z.parent().scroll(function() {
							if (A._triggered) {
								...
								y = setTimeout(function() {
									var D = v(A);
									A._editView.editBtn.animate({
										left : D.left,
										top : D.top
									}, A._editView.editing ? "fast" : 0);
									y = null
								}, 300)
							}
						});
								...
								.extend(
										this,
										{
											...
											editRow : function(D) {
												...
												b.call(this._getTrs().eq(D)[0],
														this)
											},
											deleteRow : function(F) {
												if (!i(this)
														|| (this._triggered && this._editView.editing)) {
													return
												}
											...
											getChanges : function(H) {
												var J = {
													...
													insert : [],
													"delete" : []
												}, D = H ? H : "update", G = this._changeData, F;
												if (D === "update") {
													var E = G[D];
													for (F in E) {
														l.call(E, F)
											...
											insertRow : function(O, I, R) {
												var F = this.options, P = this
														._getColModel(), E = this.element;
												...
												O = ("begin" == O || O == undefined) ? 0
														: ("end" == O ? G.length
																: O);
												for ( var K = 0, N = P.length; K < N; K++) {
													S[P[K]["name"]] = ""
												}
												this._changeData.insert[this._guid] = d
														.extend(true, S, I);
												var Q = this
														._buildRowCellValues(P,
																S, O), D = [], H = F.rowClasses;
														isRowClassesFn = (typeof H === "function"),
														rowCls = isRowClassesFn ? H(
																O, S)
																: H[O
																		% H.length],
														tdTmp = "<td align='$' abbr='$' class='grid-cell-dirty $'><div align='$' class='$' style='width:$px'>$</div></td>";
												D
														.push("<tr class='om-grid-row "
																+ rowCls
																+ "' _grid_row_id="
																+ (this._guid++)
																+ " _insert='true'>");
												...
												if (O == 0) {
													...
													J = L.next();
													L = J
															.hasClass("rowExpand-rowDetails") ? J
															: L;
													L.after(M)
												}
												if (!R) {
											...
											saveChanges : function() {
												...
												var F = this._changeData.update, E = this.element
														.find("tr.om-grid-row"), H = [];
												for ( var G in F) {
													if (l.call(F, G)) {
														d
																.extend(
																		true,
																		this._rowIdDataMap[G],
																		F[G])
													}
												}
												var D = this;
											...
											getData : function() {
												var D = this.pageData.data, F = this
														._getTrs(), E = this;
												if (i(this) && h(this)) {
													D = {
														total : D.total
		...
		H
				...
				.each(
						function(Q) {
							...
							if (!H._triggered) {
								if (!P
										|| (P && (P.editable === false || (d
												.isFunction(P.editable) && P
												.editable() === false)))) {
									var R = P && P.renderer;
									N.editor = P = {};
									P.type = "text";
							...
							if (!K) {
								O = d("<div style='position:absolute'></div>")
										.css({
											left : T.position().left + A,
											top : 3
										}).appendTo(B).addClass(
												"grid-edit-wrapper");
								K = w.instance = d("<input></input>").attr({
									name : V,
									id : V
								}).appendTo(O);
								if ("text" != S && "custom" != S) {
								...
								if ("omCalendar" == S || "omCombo" == S) {
									...
									if ("custom" == S) {
										K = w.instance = O.html(P.renderer
												.call(H, F, z))
									}
									K.width(T.outerWidth(true)
											- (K.outerWidth(true) - K.width()))
								}
								w.model = N;
								w.type = S;
								w.id = N.name;
	...
	function h(x) {
		var w = x._changeData;
		return !(d.isEmptyObject(w.update) && d.isEmptyObject(w.insert) && d
				.isEmptyObject(w["delete"]))
	}
	function q(H, D) {
		var w = H.element, G = w.next(".grid-edit-view"), F, C, A = d(D)
				.position(), y = w.parent().scrollTop(), x = H.options;
		if (G.length == 0) {
			G = d(
					"<div class='grid-edit-view'><div class='body-wrapper'><div class='grid-edit-row'><form class='grid-edit-form'></form></div><div class='gird-edit-btn'><input type='button' class='ok' value='确定'/><input type='button' class='cancel' value='取消'/></div></div></div>")
					.width(w.outerWidth()).insertAfter(w);
			...
			var B = F.find("input.ok").omButton(), z = F.find("input.cancel")
					.omButton();
			B.click(function() {
	...
	function o(F, C, y) {
		var w = F.element, B = F._editView, E = B.view, x = w.parent()
				.scrollLeft(), D = B.editBtn, z;
		E.width(w.outerWidth());
		F._getHeaderCols().each(
				function(G, I) {
					var K = d(I).attr("abbr"), H = d(I), J = C
							&& C.prop("abbr") === H.prop("abbr");
					if (J) {
						z = true
					}
					if (C && !z) {
					...
					d.each(F._editComps, function(M, L) {
						...
						if (K == L.id) {
							if (!J && C) {
								O.closest("div.grid-edit-wrapper").css("left",
										"+=" + y);
								return false
							}
							if (!J) {
								O.closest("div.grid-edit-wrapper").width(
										H.outerWidth()).css("left",
										H.position().left + x)
							}
							if ("omCalendar" == N || "omCombo" == N) {
								...
								if ("omCalendar" == N) {
									...
									O.width(H.outerWidth(true)
											- (P.outerWidth(true) - O.width()))
								} else {
									O.next("input").width(
											H.outerWidth(true)
													- (P.outerWidth(true) - O
	...
	function c(w, A) {
		var y = d(A), D = w._editView.editRow, C = w._editComps, B = a(y), x = w
				._getTrs().index(y), z = w._getRowData(x);
	...
	function u(w, x) {
		var y = a(x);
		return d(x).attr("_insert") ? w._changeData.insert[y]
				: w._rowIdDataMap[y]
	}
	function p(x) {
		var w = x._editView.editRow.find(">.grid-edit-form"), A = {}, B = A.rules = {}, z = A.messages = {}, y = x
				._getColModel();
		d.each(y, function(I, G) {
			var H = G.editor.rules;
			if (H) {
				var C = B[G.editor.name || G.name] = {}, E = z[G.editor.name
						|| G.name] = {};
				...
				.each(
						...
						function(E, D) {
							...
							if (G.editable && G.rules) {
								var F = G.name || D.model.name, H = x._errorHolders[F], C = D.type == "omCombo" ? D.instance
										.next("input")
										: D.instance;
...
(function(a) {
	a.omWidget
			.addInitListener(
					"om.omGrid",
					function() {
						var k = this, d = this.options, c = d.rowDetailsProvider, i = d.colModel, g = this.thead;
						if (!(c && i.length > 0)) {
							return
						}
						g
								.find("th:first")
								.before(
										'<th align="center" axis="expenderCol" class="expenderCol" rowspan='
												+ (a.isArray(i[0]) ? i.length
														: 1)
												+ '><div style="text-align: center; width: 14px;"></div></th>');
						var b = -1, h = 0;
						i = this._getColModel();
						a(i).each(function(l) {
							if (i[l].width == "autoExpand") {
								b = l
							} else {
								h += i[l].width
							}
						});
						var e = g.find('th[axis="expenderCol"]').width();
						if (b != -1) {
							g.find('th[axis="col' + b + '"] >div').css("width",
									"-=" + e)
						} else {
							if (d.autoFit) {
								var f = e / h;
						...
						var j = this._getHeaderCols().size();
						this.tbody
								.delegate(
										"td.expenderCol >div",
										"click",
										function(n) {
											...
											if (m
												...
												var o = k._getTrs().index(l);
												rowData = k._getRowData(o),
														rowDetails = c ? c(
																rowData, o)
																: "&#160;";
												l
														.after('<tr class="rowExpand-rowDetails"><td colspan="'
																+ (j - 1)
																+ '"><div class="rowExpand-rowDetails-content">'
																+ rowDetails
																+ "</div></td></tr>")
											}
											p
...
(function(b) {
	...
	function c(d, e) {
		...
		if ("input" === e) {
			return g != b(".pControl input", d.element.closest(".om-grid"))
					.val()
		} else {
			if ("reload" === e) {
				return true
	...
	b.omWidget
			.addInitListener(
					"om.omGrid",
					function() {
						var f = this, e = this._getColModel(), h = this
								._getHeaderCols().filter("[axis^='col']"), j = this.pDiv;
						b(h)
								.each(
										function(i) {
											var k = e[i].sort;
											if (k) {
												...
												l
														...
														.first()
														.append(
																'<img class="om-grid-sortIcon" src="data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="></img>')
											}
										});
	...
	a
			.omWidget(
					"om.omItemSelector",
					{
						...
						_create : function() {
							this.element
									.addClass("om-itemselector om-widget")
									.html(
											'<table style="height:100%;width:100%" cellpadding="0" cellspacing="0"><tr><td class="om-itemselector-leftpanel"></td><td class="om-itemselector-toolbar"></td><td class="om-itemselector-rightpanel"></td></tr></table>');
							...
							var b = a("<th></th>")
									...
									.append(
											a('<div class="header"><span class="checkbox"/><span class="om-itemselector-title"/></div>'));
							a("<tr></tr>").append(b).appendTo(d);
							this.leftPanel = a(
									'<table cellspacing="0" cellpadding="0"></table>')
									.append(d)
									.append(
											'<tr><td><div class="om-itemselector-up"><span class="upbtn"/></div><div class="om-itemselector-items"><dl></dl></div><div class="om-itemselector-down"><span class="downbtn"/></div></tr></td>')
									.appendTo(c.eq(0));
							this.toolbar = a("<div></div>").appendTo(c.eq(1));
							this.rightPanel = this.leftPanel.clone().appendTo(
									c.eq(2))
						},
						_init : function() {
							var d = this.options, c = d.dataSource;
							this.leftPanel.find(".om-itemselector-title").html(
									a.om.lang._get(d, "omItemSelector",
											"availableTitle"));
							this.rightPanel.find(".om-itemselector-title")
									.html(
											a.om.lang._get(d, "omItemSelector",
													"selectedTitle"));
							this.element.css({
						...
						_buildToolbar : function() {
							...
							for ( var c = 0, b = f.length; c < b; c++) {
								var e = f[c];
								d += '<div class="om-icon om-itemselector-tbar-'
										+ e
										+ '" title="'
										+ (a.om.lang._get({}, "omItemSelector",
												e + "IconTip") || "")
										+ '"></div>'
							}
							this.toolbar.html(d)
						...
						_resizePanel : function() {
							var d = this, f = d.leftPanel, g = d.rightPanel, c = a(
									".om-itemselector-items", f), i = a(
									".om-itemselector-items", g), e = f
									.parent().innerHeight()
									- c.offset().top + f.offset().top, b = (a(
									"tr", d.element).innerWidth() - d.toolbar
									.outerWidth()) / 2, h = f.outerWidth(b)
									.innerWidth();
							c.outerHeight(e).width(h);
							i.outerHeight(e).width(h);
							d.element
									.data("dltop", a(
											".om-itemselector-items >dl", f)
											.offset().top)
						},
						_buildList : function() {
							var f = this.options;
									...
									value = f.value,
									fmt = f.clientFormatter,
									leftHtml = "",
									rightHtml = "",
									inArray = function(k, h) {
							...
							a(".om-itemselector-items>dl", this.leftPanel)
									.html(leftHtml);
							a(".om-itemselector-items>dl", this.rightPanel)
									.html(rightHtml);
							var c = a(".om-itemselector-items"), b = a(
									">dl>dt", c).outerHeight(), d = c
									.outerHeight(), e = b - d % b;
							c.outerHeight(d + e)
						},
						_bindEvents : function() {
							var b = this, c = b.toolbar;
							b.leftPanel.delegate(
									".om-itemselector-items>dl>dt",
									"click.omItemSelector", function(d) {
										a(this).toggleClass(
												"om-state-highlight");
										b._refreshHeaderCheckbox(b.leftPanel)
									});
							b.rightPanel.delegate(
									".om-itemselector-items>dl>dt", "click",
									function(d) {
										a(this).toggleClass(
												"om-state-highlight");
										b._refreshHeaderCheckbox(b.rightPanel)
									});
							this.leftPanel.delegate(
									".om-itemselector-items>dl>dt", "dblclick",
									function() {
										a(".om-itemselector-items>dl>dt",
												b.element).removeClass(
												"om-state-highlight");
										a(this).addClass("om-state-highlight");
										b._moveItemsToTarget(
												".om-state-highlight", true)
									});
							this.rightPanel.delegate(
									".om-itemselector-items>dl>dt", "dblclick",
									function() {
										a(".om-itemselector-items>dl>dt",
												b.element).removeClass(
										...
										a(this).addClass("om-state-highlight");
										b._moveItemsToTarget(
												".om-state-highlight", false)
									});
							a(".om-itemselector-tbar-add", c).click(
									function() {
										b._moveItemsToTarget(
												".om-state-highlight", true)
									});
							a(".om-itemselector-tbar-remove", c).click(
									function() {
										b._moveItemsToTarget(
												".om-state-highlight", false)
									});
							a(".header span.checkbox", b.leftPanel).click(
									function() {
										var d = b.leftPanel, e = a(
												".om-itemselector-items>dl>dt",
												d);
										a(this).toggleClass("selected");
										if (a("div.om-itemselector-up:visible",
												d).length > 0) {
							...
							a(".header span.checkbox", b.rightPanel).click(
									function() {
										var d = b.rightPanel, e = a(
												".om-itemselector-items>dl>dt",
												d);
										a(this).toggleClass("selected");
										if (a("div.om-itemselector-up:visible",
							...
							b.element.delegate(
									"div.om-itemselector-up:not([disabled])",
									"click", function() {
										b._page(a(this), true);
										b._refreshHeaderCheckbox(a(this)
												.parentsUntil("table").last()
												.parent())
									});
							b.element.delegate(
									"div.om-itemselector-down:not([disabled])",
									"click", function() {
						...
						_page : function(e, c) {
							var i = c ? e.next() : e.prev(), f = i
									.children("dl"), g = i.outerHeight() - 2, b = f
									.outerHeight(), k = f.offset().top, d, j = this.element
									.data("dltop") + 20;
							if (c) {
								f.offset({
									top : k + g
						...
						_refreshHeaderCheckbox : function(b) {
							...
							a(".header span.checkbox", b).toggleClass(
									"selected", c > 0 && d.length === c)
						},
						_refreshPageButton : function(c) {
							var g = a(".om-itemselector-items", c), e = a(
									".om-itemselector-items >dl", c), d = a(
									".om-itemselector-up", c), i = a(
									".om-itemselector-down", c), f = g
									.outerHeight(), b = e.outerHeight(), j = e
							...
							if (b > f) {
								...
								if (j > 0 && j < f) {
									d.attr("disabled", "disabled").addClass(
											"om-itemselector-up-disabled")
								} else {
									d.removeAttr("disabled").removeClass(
											"om-itemselector-up-disabled")
								...
								if (j > 0 || (b + j - h) > (f)) {
									i.removeAttr("disabled").removeClass(
											"om-itemselector-down-disabled")
								} else {
									i.attr("disabled", "disabled").addClass(
											"om-itemselector-down-disabled")
								}
							} else {
								if (d.is(":visible")) {
						...
						_getPageItems : function(b, l) {
							var i = a(".om-itemselector-items", b), f = i
									.outerHeight(), e = a(">dl", i), d = [], h = i
									.next(":visible").length > 0, c = l
									.outerHeight(), g = f / c, k = e.offset().top, j = this.element
									.data("dltop");
							k = h ? j - k + 20 : j - k;
						...
						select : function(d) {
							...
							for ( var c = 0, b = d.length; c < b; c++) {
								a(
										'.om-itemselector-items>dl>dt[_index="'
												+ d[c] + '"]').addClass(
										"om-state-highlight")
							}
						},
						_moveItemsToTarget : function(c, d) {
							var e = this, f = d ? this.leftPanel
									: this.rightPanel, i = a(
									".om-itemselector-items>dl>dt" + c, f);
							if (i.size() == 0) {
								return
							}
							...
							if (d) {
								...
								i.appendTo(a(".om-itemselector-items>dl", g))
										.removeClass("om-state-highlight");
						...
						value : function(c) {
							if (arguments.length == 0) {
								var e = this.options, d = a(
										".om-itemselector-items>dl>dt",
										this.rightPanel), b = [];
								d.each(function() {
									b
											.push(e.dataSource[a(this).attr(
													"_index")].value)
								});
								return b
							} else {
					...
					"om.omMenu",
					{
						...
						show : function(b) {
							...
							if (k.contextMenu) {
								...
								var g = parseInt(a(b).css("borderBottomWidth")
										.replace("px", ""));
								h = e.top + a(b).height()
										+ (g != "NaN" ? g : 0) + 1;
								d = e.left + 1
						...
						disableItem : function(b) {
							this.element.find("#" + b).addClass(
									"om-state-disabled").unbind(".menuItem")
						},
												...
												if (l.children != null) {
													if (l.disabled === true
														...
														g
																.push('<li id="'
																		+ l.id
																		+ '" aria-haspopup="true"  class="om-state-disabled">')
													} else {
														g
																.push('<li id="'
																		+ l.id
												...
												function(g, f) {
													if (a(f)
														...
														if (e.width() > c.options.maxWidth) {
															e
																	.width(c.options.maxWidth);
															width = c.options.maxWidth * 0.6
														} else {
															if (e
																	.attr("hasShow") == undefined) {
																e
																		.width(e
																				.find(
																						"li:eq(0)>a:eq(0)")
						...
						_bindEvent : function() {
							var b = this, g = b.element, h = g.find("ul"), d = g
									.find("li"), k = a(document), f;
							for ( var e = 0; e < d.length; e++) {
						...
						_findNext : function(b) {
							...
							while ((c = b.next("li")).length !== 0) {
								if (!c.hasClass("om-menu-sep-li")
										&& !c.hasClass("om-state-disabled")) {
									return c
								}
								b = c
							}
							...
							while (d.length !== 0 && d != e) {
								if (!d.hasClass("om-menu-sep-li")
										&& !d.hasClass("om-state-disabled")) {
									return d
								}
								d = d.next("li")
							}
						...
						_findPrev : function(b) {
							...
							while ((e = b.prev("li")).length !== 0) {
								if (!e.hasClass("om-menu-sep-li")
										&& !e.hasClass("om-state-disabled")) {
									return e
								}
								b = e
							}
...
(function(d, f) {
	...
	var g = function(j) {
		...
		var p = d('<div class="om-widget-overlay"/>').appendTo(document.body)
				.show().css({
					height : c(),
					width : a()
				});
		...
		case "confirm":
			m
					.html('<button id="confirm">确定</button><button id="cancel">取消</button>');
			if (d.fn.omButton) {
				...
				m.find("button#confirm").omButton(
						{
							width : 60,
							onClick : function(r) {
								var q = o ? o(d("#om-messageBox-prompt-input")
										.val()) : jQuery.noop();
								if (q !== false) {
									k.remove();
									p.remove()
		...
		case "waiting":
			...
			i.hide();
			m.parent().hide();
			k.find(">.om-messageBox-content").addClass(
					"no-button om-corner-bottom");
			break;
		default:
...
(function(a, b) {
	a.omMessageTip = {
		show : function(d) {
			...
			var e = '<div class="om-messageTip om-widget om-corner-all" tabindex="-1"><div class="om-widget-header om-corner-top om-helper-clearfix"><span class="om-messageTip-title">'
					+ d.title
					+ '</span><a href="#" class="om-messageTip-titlebar-close om-corner-tr"><span class="om-icon-closethick"></span></a></div><div class="om-messageTip-content om-widget-content om-corner-bottom"><div class="om-messageTip-image om-messageTip-image-'
					+ d.type
			...
			g.find("a.om-messageTip-titlebar-close").bind(
					...
					"om.omNumberField",
					{
						...
						_create : function() {
							...
							this.element
									.keypress(
											function(h) {
												if (h.which == null
														&& (h.charCode != null || h.keyCode != null)) {
													h.which = h.charCode != null ? h.charCode
															: h.keyCode
												}
												var f = h.which;
												if (f === 8
						...
						disable : function() {
							this.element.attr("disabled", true).addClass(
									"om-numberfield-disabled")
						},
						enable : function() {
							this.element.attr("disabled", false).removeClass(
									"om-numberfield-disabled")
						}
					})
})(jQuery);
			...
			.omWidget(
					"om.omProgressbar",
					{
						...
						_create : function() {
							...
							this.textDiv = a(
									"<div class='om-progressbar-text'></div>")
									.appendTo(b);
							this.valueDiv = a(
									"<div class='om-progressbar-value om-widget-header om-corner-left'></div>")
									.appendTo(b)
						},
						_init : function() {
						...
						_refreshValue : function() {
							...
							d.valueDiv.toggle(f > d.min).toggleClass(
									"om-corner-right", f === d.options.max)
									.width(b.toFixed(0) + "%");
			...
			.omWidget(
					"om.omScrollbar",
					{
						...
						_create : function() {
							var b = this.options;
							this._vScrollbar = a(
									"<div class='om-widget om-scrollbar om-corner-all'></div>")
									.width(b.thick).appendTo("body").hide();
							this._vScrollbar.type = "v";
							this._hScrollbar = a(
									"<div class='om-widget om-scrollbar om-corner-all'></div>")
									.height(b.thick).appendTo("body").hide();
						...
						_buildEvent : function() {
							var e = this, d = this.element, c = [
									this._vScrollbar, this._hScrollbar ];
							a(c)
									.each(
											function(g, i) {
												i._hover = false;
							...
							var b = a.browser.mozilla ? "DOMMouseScroll"
									: "mousewheel";
							d.bind(b, function(f) {
						...
						_mousewheelListener : function(d) {
							...
							var b = j / 120 * 10, f = k._vScrollbar, e = k.element, h = e
									.offset().top
									+ k._getInt(e.css("border-top-width"))
									+ k._getInt(e.css("padding-top"))
									+ k._getInt(e.css("padding-top-width")), g = f
									.position().top
									- h, i = e.height(), c = i
									- f.outerHeight();
							if (b + g < 0) {
						...
						_resize : function(d) {
							var b = this.element, k = d.type, q = 0, g = b
									.offset(), l = b.width(), i = b.height(), e = b
									.outerWidth(), n = b.outerHeight(), c = this
									._getInt(b.css("border-left-width")), o = this
									._getInt(b.css("border-right-width")), m = this
									._getInt(b.css("border-top-width")), j = this
									._getInt(b.css("border-bottom-width")), f = this
									._getInt(b.css("padding-left")), p = this
									._getInt(b.css("padding-top"));
							if ("v" === k) {
								q = b[0].scrollHeight;
								if (q > i) {
									d._enable = true;
									d.outerHeight(this._getInt(i
											* b.innerHeight() / q));
									d.css({
								...
								if ("h" === k) {
									...
									if (q > b.innerWidth()) {
										d._enable = true;
										d.outerWidth(this._getInt((f + l) * l
												/ q));
										d.css({
											left : g.left
													+ c
	...
	a
			.omWidget(
					"om.omSlider",
					{
						...
						destroy : function() {
							var c = this.element, b = this.options, d = this
									._getSliderVars(c);
							clearTimeout(d.slideTimer);
							clearInterval(d.autoPlayTimer);
							if (d.customNav) {
								a(b.controlNav).children().unbind(".omSlider")
										.removeData("sid").removeClass(
												b.activeNavCls)
							}
						},
						...
						_runSlideEffect : function(c, f, n) {
							var h = this, g = this._getSliderVars(c), l = c
									.find("ul.om-slider-content:first"), j = l
									.children(), b = this.options, i = 0, d = 0;
							var m = n ? n : b.effect;
							if (b.effect == "random") {
							...
							l.animate({
								top : i,
								left : d
							}, b.animSpeed, function() {
								g.running = false;
								h._trigger("onAfterSlide", null, f)
							})
						},
						_runFadeEffect : function(f, d) {
							var b = this, g = this._getSliderVars(f), c = f
									.find("ul.om-slider-content:first")
									.children(), e = this.options;
							c.each(function(i) {
								var h = a(this);
								if (i == d) {
									g.running = true;
						...
						_runNoEffect : function(f, d) {
							var b = this, g = this._getSliderVars(f), e = this.options, c = f
									.find("ul.om-slider-content:first")
									.children();
							c.each(function(i) {
								var h = a(this);
						...
						_slideTo : function(f, c) {
							var g = this._getSliderVars(f), h = f
									.find("ul.om-slider-content:first");
						...
						_processDirectionNav : function(d) {
							var e = this._getSliderVars(d), c = a(
									'<div class="om-slider-directionNav">')
									.appendTo(d), b = this;
							a('<a class="om-slider-prevNav"></a>').appendTo(c)
									.click(function() {
										if (e.running) {
											return false
										}
							...
							a('<a class="om-slider-nextNav"></a>').appendTo(c)
									.click(function() {
										if (e.running) {
											return false
										}
						...
						_processControlNav : function(g) {
							...
							if (f.controlNav === true
									|| f.controlNav === "classical") {
									...
									c
											.hover(
													function() {
														...
														var j = a(this);
														if (j
																.hasClass(f.activeNavCls)) {
															return false
														}
														h.slideTimer = d = setTimeout(
																function() {
																	e
																			._slideTo(
																					g,
								...
								if (f.controlNav === "dot") {
									...
									for (i = 0; i < h.totalSlides; i++) {
										var c = a('<a href="javascript:void(0)">'
												+ (i + 1) + "</a>");
										c.data("sid", i);
										var d = 0;
										c.click(function() {
						...
						_create : function() {
							...
							g.data("omSlider", g).data("omSlider:vars", f)
									.data("omSlider:opts", e).addClass(
											"om-slider");
							if (e.startSlide > 0) {
								f.currentSlide = e.startSlide
							}
							var d = g.children();
							d.wrapAll('<ul class="om-slider-content"></ul>')
									.wrap('<li class="om-slider-item"></li>');
							if (e.effect == "slide-v" || e.effect == "slide-h") {
								g.find(".om-slider-content").addClass(
										"om-slider-effect-" + e.effect)
							}
							...
							function c(k, j) {
								...
								var n = k.find("ul.om-slider-content:first"), i = n
										.children(), m = 0, l = 0;
								if (e.effect == "slide-h") {
									i.each(function(o) {
										if (o == j) {
							...
							if (e.startSlide > 0
									&& (e.effect == "slide-h" || e.effect == "slide-v")) {
	...
	c
			.omWidget(
					"om.omSuggestion",
					{
						...
						destroy : function() {
							c(document).unbind("mousedown.omSuggestion",
									this.globalEvent);
							this.dropList.parent().remove()
						},
						_clear : function() {
						...
						_suggest : function() {
							...
							if (i.length > 0 && i.length >= l.minChars) {
								...
								if (l.onBeforeSuggest) {
									if (this._trigger("onBeforeSuggest", null,
											i) === false) {
			...
			.omWidget(
					"om.omTabs",
					{
						...
						_makeSketch : function() {
							this.element
									.addClass(
											"om-tabs om-widget om-widget-content om-corner-all")
									.append(
											'<div class="om-tabs-panels om-widget-content om-corner-bottom" />')
									.find(">ul")
									.wrap(
											'<div class="om-tabs-headers om-helper-reset om-helper-clearfix om-widget-header om-corner-all" />');
						...
						_collectItems : function() {
							...
							$('<span class="left-placeholder"></span>')
									.insertBefore($lis.eq(0));
							$('<span class="right-placeholder"></span>')
									.insertAfter($lis.eq($lis.length - 1));
							if (h.length > 0) {
								this.loadInfo = h
							}
							this.items = i
						...
						_render : function() {
							var h = this, l = this.element, j = this.options, g = this.items, k = l
									.find(">div.om-tabs-headers");
						...
						_renderHeader : function() {
							...
							$headers = j.find(">div.om-tabs-headers"),
							...
							$lis
									.each(function(l) {
										...
										$('<span class="lileft"></span>')
												.insertBefore(k);
										if (g.closable === true
												|| ($.isArray(g.closable) && -1 !== $
														.inArray(l, g.closable))) {
											if (k.next(".om-icon-close").length <= 0) {
												$(
														'<a class="om-icon om-icon-close"></a>')
														.insertAfter(k)
											}
						...
						_renderBody : function() {
							var n = this.element, j = this.options, h = this.items, m = n
									.find(">div.om-tabs-panels");
							m.children().detach();
							if (j.height !== "auto") {
								var g = n.innerHeight(), l = n.find(
										">div.om-tabs-headers").outerHeight();
								m.css("height", g - l)
							}
							n.toggleClass("om-tabs-noborder", !j.border);
							var k = h.length;
							while (k--) {
								h[k].addClass("om-state-nobd").parent()
										.prependTo(m)
							}
						},
							...
							n
									...
									.each(
											function() {
												$(this)
														.is(
																".om-tabs-headers,.om-tabs-panels")
														|| $(this).remove()
											});
							if (!k.lazyLoad) {
								$(h).omPanel("reload")
						...
						_buildEvent : function() {
							var j = this, n = this.element, g = this.options, h = n
									.find(">div.om-tabs-headers a.om-icon-close");
							h.unbind("click.omtabs").bind(
									"click.omtabs",
									function(p) {
										var o = $(p.target).prev()
												.attr("tabId");
							...
							var l = n
									.find(">div.om-tabs-headers a.om-tabs-inner");
							if (g.switchMode.indexOf("mouseover") != -1) {
								l.bind("mouseover.omtabs", function() {
									var o = $(this).attr("tabId"), p = $.data(
											n, "activateTimer");
									(typeof p !== "undefined")
											&& clearTimeout(p);
							...
							n.find(">div.om-tabs-headers >span").bind(
									"click.omtabs",
									function(o) {
										if ($(this).hasClass(
												"om-tabs-scroll-disabled")) {
											return false
										}
						...
						_activate : function(s) {
							...
							if (j.onBeforeActivate
									&& this._trigger("onBeforeActivate", null,
											s) === false) {
								return false
							}
							...
							if (this._checkScroller()) {
								...
								var m = q.offset().left + q.outerWidth(true)
										+ 4 - t;
							...
							j.onActivate
									&& this._trigger("onActivate", null, s)
						},
						...
						_getAlter : function(i) {
							...
							if (typeof i == "number") {
								g = h.find(
										">div.om-tabs-headers li:eq(" + i
												+ ") a.om-tabs-inner").attr(
										"tabId")
							} else {
								if (typeof i == "string") {
									h
											.find(
													">div.om-tabs-headers li a.om-tabs-inner")
											.each(
													function(j) {
														if ($(this).attr(
																"tabId") == i) {
						...
						_add : function(i) {
							...
							if (q.onBeforeAdd
									&& m._trigger("onBeforeAdd", null, i) == false) {
								return false
							}
							var n = $('<li class="om-state-default om-corner-top"> </li>');
							var p = $('<a class="om-tabs-inner"></a>').html(
									i.title).attr({
								href : "#" + h,
								tabId : h
							}).css({
							...
							if ((i.closable === true)
									|| (i.closable == undefined && q.closable)) {
								p
										.after('<a class="om-icon om-icon-close"></a>');
								$('<span class="liright"></span>').insertAfter(
										p.next(".om-icon-close"))
							} else {
								$('<span class="liright"></span>').insertAfter(
										p)
							}
							...
							var g = new a($("<div>" + (i.content || "")
									+ "</div>")[0], k);
							if (i.index == l.length) {
								l[i.index] = g;
								n
										.insertBefore(j
												.find("span.right-placeholder"))
							} else {
							...
							this._checkScroller() && this._enableScroller();
							l[i.index].addClass("om-state-nobd").parent()
									.insertAfter(
											i.index > 0 ? o.find(
													">div.om-tabs-panels")
													.children().eq(i.index - 1)
													: 0);
							this._purgeEvent();
							this._buildEvent();
						...
						_close : function(m) {
							var p = this.element, q = this.options, n = this.items, o = p
									.find(">div.om-tabs-headers"), h = p
									.find(">div.om-tabs-panels"), k = p
									.height(), j = m, g = this.history;
							...
							if (q.onBeforeClose
									&& this._trigger("onBeforeClose", null, m) == false) {
								return false
							}
							this._removeLoadInfo(this._getAlter(m));
							o.find("li").eq(m).remove();
							h.children().find(">.om-panel-body").eq(m).empty()
									.remove();
							n.splice(m, 1);
							if (h.children().length == 0) {
								h.css({
									height : k - o.outerHeight()
								})
							}
						...
						_closeAll : function() {
							var o = this.element, k = this.options, j = this.items, n = o
									.find(">div.om-tabs-headers"), m = o
									.find(">div.om-tabs-panels"), h = o
									.height();
							if (k.onBeforeCloseAll
									&& this._trigger("onBeforeCloseAll") === false) {
								return false
							}
							for ( var l = 0, g = j.length; l < g; l++) {
								this._removeLoadInfo(j[l].omPanel("option",
										"tabId"))
							}
							n.find("li").remove();
							m.empty();
						...
						_checkScroller : function() {
							...
							if (h > j.parent().innerWidth()) {
								if (!j.hasClass("om-tabs-scrollable")) {
									var m = $("<span></span>").insertBefore(j)
											.addClass("om-tabs-scroll-left");
									var i = $("<span></span>").insertAfter(j)
											.addClass("om-tabs-scroll-right");
									var g = (j.height() - m.height()) / 2;
									j.addClass("om-tabs-scrollable")
								}
								return true
							} else {
								j.removeClass("om-tabs-scrollable").siblings()
										.remove();
								return false
							}
						},
						...
						_enableScroller : function() {
							var n = this.element.find(">div.om-tabs-headers"), l = n
									.children("ul"), o = l.prev(), j = l.next(), m = l
									.children(":last"), g = n.offset().left, k = j
									.offset().left, h = l.offset().left, i = m
									.offset().left
									+ m.outerWidth(true);
							o.toggleClass(c + " om-tabs-scroll-disabled-left",
									h >= g);
							j.toggleClass(c + " om-tabs-scroll-disabled-right",
									i <= k)
						},
						_scroll : function(k, i) {
							var g = this;
							$self = this.element, $ul = $self
									.find(">div.om-tabs-headers ul"), $li = $ul
									.children(":last");
							if (k == 0) {
								return
							}
							var h = k > 0 ? $ul.prev().offset() : $ul.next()
									.offset();
							var j = function(m) {
								if (k > 0 && $ul.prev().hasClass(c) || k < 0
										&& $ul.next().hasClass(c)) {
									$ul.stop(true, true);
									$self.clearQueue();
									return
								...
								var l = false;
								k = (k > 0) ? "+="
										+ Math.min(h.left - $ul.offset().left,
												k) : "-="
										+ Math.min(
												$li.offset().left
														+ $li.outerWidth(true)
						...
						_setDataSource : function(j) {
							var k = this.element, g = this.items, i = this.options, h = this
									._getAlter(j.index);
							j.url = $.trim(j.url);
						...
						_reload : function(j, i, k) {
							var l = this.element, g = this.items, h = this
									._getAlter(j);
							if (i) {
								this._removeLoadInfo(h);
			...
			.omWidget(
					"om.omTooltip",
					{
						...
						_create : function() {
							...
							this.tip = a('<div class="tip"></div>').append(
									this.tipContent)
						},
						_init : function() {
							...
							if (d.height != "auto") {
								this.tip.css("height", d.height
										- c.adjustHeight)
							} else {
								this.tip.css("height", "auto")
							}
							if (d.minWidth) {
								this.tip.css("minWidth", d.minWidth
										- c.adjustWidth)
							}
							if (d.maxWidth) {
								this.tip.css("maxWidth", d.maxWidth
										- c.adjustWidth)
							}
							if (d.maxHeight) {
								this.tip.css("maxHeight", d.maxHeight
										- c.adjustHeight)
							}
							if (d.minHeight) {
								this.tip.css("minHeight", d.minHeight
										- c.adjustHeight)
							}
							if (d.url && !d.lazyLoad) {
								c._ajaxLoad(d.url)
						...
						_ajaxLoad : function(c) {
							...
							a.ajax({
								...
								error : function(d, f, e) {
									b.tip.find(".tip-body").append(
											a.om.lang.omTooltip.FailedToLoad)
								}
							})
						},
						_bindEvent : function() {
							...
							if (c.showOn == "mouseover") {
								...
								if (c.showOn == "click") {
									b.showTime = d.bind("click.tooltip",
											function(f) {
												setTimeout(function() {
													b.show(f)
												}, c.delay)
						...
						_adjustPosition : function(g) {
							var b = this, c = b.options, d = b.element, i, h, f = a(
									d).offset();
							if (g && !c.region) {
								i = g.pageY + c.offset[0];
								h = g.pageX + c.offset[1];
								b.tip.find(".tip-anchor").css({
									top : c.anchorOffset + 3,
									left : "-9px"
								}).addClass("tip-anchor-left")
							} else {
								var e = parseInt(a(d).css("borderBottomWidth")
										.replace("px", ""));
								i = f.top + a(d).height() + (isNaN(e) ? 0 : e)
										+ c.offset[0];
								h = f.left + c.offset[1];
								if (c.region == "right") {
									h = f.left + c.offset[1] + a(d).width()
											+ b.adjustWidth;
									i = i - b.element.height() + b.adjustHeight
											+ c.offset[0];
									b.tip.find(".tip-anchor").css({
										top : c.anchorOffset + 3,
										left : "-9px"
									...
									if (c.region == "left") {
										h = f.left - b.tip.width()
												- b.adjustWidth - c.offset[1]
												- 2;
										i = i - b.element.height()
												- b.adjustHeight - c.offset[0];
										b.tip.find(".tip-anchor").css({
											top : c.anchorOffset + 3,
											left : b.tip.outerWidth() - 2
										})
									} else {
										if (c.region == "top") {
											i = i
											...
											h = h + c.offset[1];
											b.tip.find(".tip-anchor").css({
												top : b.tip.outerHeight() - 3,
												left : c.anchorOffset + 3
											})
										} else {
											if (c.region == "bottom") {
												i = i + c.offset[0];
								...
								b.tip.find(".tip-anchor").addClass(
										"tip-anchor-" + b.regionMap[c.region])
							}
							if ((h + b.tip.width()) > document.documentElement.clientWidth) {
								h = h - b.tip.width() - 20
							}
							if ((i + b.tip.height()) > document.documentElement.clientHeight) {
								i = i - (b.element.height() + b.tip.height())
										- 20
							}
							b.tip.css({
								top : i - a(document).scrollTop(),
								left : h - a(document).scrollLeft()
							})
						},
						hide : function() {
							this.tip.hide()
			...
			.omWidget(
					"om.omTree",
					{
						...
						_applyEvents : function(f) {
							...
							f.find("span").bind(
									...
									function(n) {
										...
										if (l.hasClass("hasChildren")) {
											l.find("span.folder").removeClass(
													"folder").addClass(
													"placeholder")
										}
										...
										l.find("span.placeholder").removeClass(
							...
							if (j.options.draggable) {
								f
										.omDraggable({
											revert : "invalid",
											onStart : function(m, n) {
												var l = j.findByNId(m.helper
														.attr("id"));
								...
								f
										.omDroppable({
											...
											onDragOver : function(n, m) {
												var l = f
														.filter(".treenode-droppable");
												if (l.length > 0) {
													l
															.removeClass("treenode-droppable")
												} else {
													a(this)
															.addClass(
																	"treenode-droppable")
						...
						_bindHitEvent : function(d) {
							var c = this;
							d.find("div.hitarea").click(
									function() {
										var e = a(this).parent();
										if (e.hasClass("hasChildren")) {
											e.find("span.folder").removeClass(
													"folder").addClass(
													"placeholder")
										}
										c.toggler(e);
										e.find("span.placeholder").removeClass(
												"placeholder").addClass(
												"folder")
									})
						},
						...
						_create : function() {
							this.element.data("nodes", []).data("selected", "")
									.data("init_dataSource", []).addClass(
											"om-tree om-widget")
						},
						...
						_ajaxLoad : function(h, e) {
							...
							g
									&& c._trigger("onBeforeLoad", null, c
											.findByNId(h.parent().attr("id")));
							a.ajax({
								url : e,
								method : "POST",
								dataType : "json",
						...
						select : function(i) {
							...
							if (f
									&& false === d._trigger("onBeforeSelect",
											null, i)) {
								return d
							}
							var h = a("#" + i.nid);
						...
						findNodes : function(h, k, g, e) {
							var d = [], c;
							var j = g ? g.children : this.element
						...
						findNode : function(h, k, g, d) {
							var f, c, j = g ? g.children : this.element
									.data("init_dataSource");
							d = (d != false) ? true : d;
							if (j && (c = j.length) > 0) {
								for ( var e = 0; e < c; e++) {
						...
						findNodesBy : function(h, g, d) {
							var f, j = g ? g.children : this.element
									.data("init_dataSource");
							d = (d != false) ? true : d;
							var c = [];
							if (j && (len = j.length) > 0) {
						...
						expand : function(f) {
							if (f.nid) {
								...
								var c = a(">div." + b.hitarea, e)
										.filter(
												function() {
													return d ? a(this).parent(
															"." + d).length
															: true
												}).parent().parentsUntil(
												this.element).andSelf().filter(
												function() {
													return a(this).filter("li")
															.hasClass(d)
												});
								this.toggler(c)
							}
						...
						refresh : function(k) {
							...
							if (!k) {
								...
								g.remove(k);
								g.insert(k, g.findByNId(f), g.findByNId(c
										.attr("id")))
							}
						},
						...
						_appendNodes : function(v, m, e, f) {
							...
							for ( var q = 0, o = m.length; q < o; q++) {
								...
								if (typeof v == "string") {
									...
									d["pid" + n.nid] = v.parent("li")
											.attr("id")
								}
								var u = [];
								if (n.children && n.children.length > 0) {
									u.push((j._appendNodes(n.nid, n.children))
											.join(""))
								}
								var r = 0;
								if (n.children && (r = n.children.length) > 0
										|| n.hasChildren) {
									if (n.expanded) {
										w = w + "open " + b.collapsable + " "
												+ (k ? b.lastCollapsable : "")
									} else {
										w = w + b.expandable + " "
												+ (k ? b.lastExpandable : "")
								...
								t.push("<span class='", p, "'>",
										"<a href='#'>", n.text, "</a></span>");
								if (n.hasChildren || r > 0) {
									t.push("<ul", " style='display:",
											(n.expanded ? "block" : "none"),
											"'>");
									t.push(u.join(""));
									t.push("</ul>")
								}
						...
						remove : function(j, l) {
							var k, m = this, f = l ? l.children : m.element
									.data("init_dataSource");
							for ( var g in f) {
								if (f[g] == j) {
									var c = [];
						...
						insert : function(j, o, c, l) {
							...
							var i, g = o ? o.children : p.element
									.data("init_dataSource");
							...
							var f = n.find("li").filter(
									"." + b.last + ",." + b.lastCollapsable
											+ ",." + b.lastExpandable).not(
									n.find("li").filter(":last-child:not(ul)"));
...
(function(a) {
	a.omWidget("om.omFiles",{
		...
		_create : function() {
			var b = 30;
			if (this.options.loadType === "des") {
				b = 5;
			}
			this.element.width(this.options.width).height(this.options.height)
				.append('<div style="height:' + (this.options.height - b)
						+ 'px" class="g_file_list"><div class="g_file_list_tip" style="line-height:'
						+ (this.options.height - b) + 'px;">'
						+ (this.options.emptyText) + '</div><input type="hidden" id="'
						+ (this.options.valueField || this.element[0].id + "Vals")
						+ '" name="' + (this.options.valueField || this.element[0].id + "Vals")
						+ '" /><ul style="height:' + (this.options.height - b)
						+ 'px;"></ul></div><div style="text-align:right;"><a></a></div>')
		},
		_init : function() {
			var d = this, c = d.element, b = this.options;
			c.find("a:eq(0)").omLinkButton({
				iconCls : "icon-add_to_folder",
				label : b.label,
				onClick : function() {
					top.lili.dialog.load({
						url : b.filePath + "?id=" + a(c).attr("id"),
						width : 635,
						height : 495,
						isID : false,
						self : self,
		...
		addLi : function(e) {
			this.element.find('div[class="g_file_list_tip"]').hide();
			var c = this, d = c.element, f = c.options;
			var b = null;
			if (f.formatHTML) {
				b = a(f.formatHTML(e)).appendTo(d.find("ul:eq(0)"));
			} else {
				if (f.swf.fileTypeDesc === "img" || f.showPic === true) {
					b = a('<li path="' + e.realFilePath + '" GUID="'
							+ e.id+ '" class="li"><span class="close">x</span><img class="img" src="'
							+ e.realFilePath + '"><a class="a">'
							+ e.filename.subs(f.maxString, 2)
							+ "</a></li>").appendTo(d.find("ul:eq(0)"));
				} else {
					b = a('<li path="' + e.realFilePath + '" title="' + e.filename
							+ '" GUID="' + e.id + '"><a>'
							+ e.filename.subs(f.maxString, 2)
							+ "</a><span>x</span></li>").appendTo(d.find("ul:eq(0)"));
				}
			}
			c.options.formData.push(e);
			c.element.find("input").val(JSON.stringify(c.options.formData));
			if (f.loadType === "des") {
				b.children("span").hide();
				if (c.options.showPic != true) {
					b.click(function() {
						if (c.options.clickLiDes) {
							c.options.clickLiDes(e);
						}
					});
				}
			} else {
				b.click(function() {
					if (c.options.clickLiEdit) {
						c.options.clickLiEdit(e);
					}
				}).children("span:eq(0)").click(function(g) {
					top.$.omMessageBox.confirm({
						title : "\u786e\u8ba4\u5220\u9664\u6587\u4ef6",
						content : "\u6587\u4ef6\u5220\u9664\u540e\u4e0d\u53ef\u6062\u590d\uff0c\u4f60\u786e\u5b9a\u8981\u8fd9\u6837\u505a\u5417\uff1f",
						onClose : function(h) {
							if (h) {
								for (var j = 0; j < c.options.formData.length; j++) {
									if (c.options.formData[j].id === e.id) {
										c.options.formData.splice(j,1);
										continue;
									}
								}
								c.element.find("input").val(JSON.stringify(c.options.formData));
								...
								if (b.siblings().size() === 0) {
									c.element.find('div[class="g_file_list_tip"]').show();
								}
								b.remove();
								b = null;
							}
		...
		_addData : function(d) {
			...
			if (this.options.loadType === "des") {
				var e = this.element.children("div"), b = e.eq(0);
				b.children("ul:eq(0)").height(b.height() + 30);
				b.height(b.height() + 30);
				e.eq(1).hide();
				if (this.options.showPic === true) {
					this.element.find("ul:eq(0)").liliPhoto(null);
				}
			}
		},
		setData : function(b) {
			this.element.find("ul:eq(0)").empty();
			if (typeof b === "string") {
				this._ajaxLoad(b);
			} else {
				this._addData(b);
		...
		_ajaxLoad : function(d) {
			var b = this;
			var c = this.options;
			if (c.loadData && typeof c.loadData == "object") {
				b._addData(c.loadData)
			} else {
				if(d){
					a.ajax({
						url : d || c.loadData,
...
(function(a) {
	a.omWidget("om.omLinkButton",{
		...
		_create : function() {
			var c = a("<span>").addClass("l-btn-left");
			var b = a("<span>").addClass("l-btn-text").css("padding-left", "20px").html(
					(this.options.label ? this.options.label : a(this).html()));
			if (this.options.iconCls) {
				b.addClass(this.options.iconCls);
			}
			this.element.empty().attr({
				title : this.options.title,
				isLimits : this.options.isLimits,
				close : this.options.close,
				hidefocus : "true"
			}).addClass("l-btn l-btn-plain").append(c.append(b));
			if (this.options.item) {
				this.element.append(
						"<span class='l-btn-right l-btn-right-icon-x'>&nbsp;&nbsp;</span>")
						.append("<div></div>");
			}
		},
		_init : function() {
			var b = this, c = this.options, d = this.element;
			if (b.options.onClick && !c.item) {
				d.removeAttr("href").removeAttr("onclick").click(function(f) {
					if (!c.disabled) {
						b._trigger("onClick",f);
						b.element.addClass("l-btn-focus");
					}
				});
			}
			var e = d.children();
			e.eq(0).children("span").bind("focus.omLinkButton",function(f) {
				if (c.disabled) {
					return false
				}
				e.addClass("l-btn-focus");
			}).bind("focus.omLinkButton", function(f) {
				this.blur();
			}).bind("blur.omLinkButton", function(f) {
				if (c.disabled) {
					return false;
				}
				e.removeClass("l-btn-focus");
			});
			if (c.disabled) {
				this.element.addClass("l-btn-disabled");
			} else {
				this.element.removeClass("l-btn-disabled");
			}
			if (c.item) {
				e.eq(2).omMenu({
				...
				this.element.hover(function() {
					e.eq(2).omMenu("show", this);
					e.eq(1).addClass("l-btn-right-icon-y")
						.removeClass("l-btn-right-icon-x");
				}, function() {
					e.eq(2).omMenu("hide");
					e.eq(1).addClass("l-btn-right-icon-x")
						.removeClass("l-btn-right-icon-y");
				});
			}
		},
		enable : function() {
		...
		setLabel : function(b) {
			if (b && typeof (b) === "string") {
				this.element.children("span:eq(0)")
					.children("span:eq(0)").html(b);
			}
		},
		setCls : function(b) {
			this.element.children("span:eq(0)").children("span:eq(0)")
				.removeClass().addClass("l-btn-text " + b);
		}
	})
})(jQuery);