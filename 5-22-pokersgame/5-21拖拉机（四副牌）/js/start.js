...
function start(){
	document.getElementById("operate").style.visibility="visible";//显示
				...
				if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")>0){//手牌只有♥2、♣2、♦2
					NewB[0].heitao2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")>0){//手牌只有♠2、♣2、♦2
					NewB[0].hongtao2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")>0){//手牌只有♠2、♥2、♦2
					NewB[0].meihua2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")<0){//手牌只有♠2、♥2、♣2
					NewB[0].fangkuai2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")>0){//手牌只有♣2、♦2
					NewB[0].heitao2=0;NewB[0].hongtao2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")>0){//手牌只有♥2、♦2
					NewB[0].heitao2=0;NewB[0].meihua2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")<0){//手牌只有♥2、♣2
					NewB[0].heitao2=0;NewB[0].fangkuai2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")>0){//手牌只有♠2、♦2
					NewB[0].hongtao2=0;NewB[0].meihua2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")<0){//手牌只有♠2、♣2
					NewB[0].hongtao2=0;NewB[0].fangkuai2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")<0){//手牌只有♠2、♥2
					NewB[0].fangkuai2=0;NewB[0].meihua2=0;
				}else if(strB.indexOf("heitao2")>0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")<0){//手牌只有♠2
					NewB[0].fangkuai2=0;NewB[0].meihua2=0;NewB[0].hongtao2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")>0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")<0){//手牌只有♥2
					NewB[0].fangkuai2=0;NewB[0].meihua2=0;NewB[0].heitao2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")>0&&strB.indexOf("fangkuai2")<0){//手牌只有♣2
					NewB[0].fangkuai2=0;NewB[0].hongtao2=0;NewB[0].heitao2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")>0){//手牌只有♦2
					NewB[0].meihua2=0;NewB[0].hongtao2=0;NewB[0].heitao2=0;
				}else if(strB.indexOf("heitao2")<0&&strB.indexOf("hongtao2")<0&&strB.indexOf("meihua2")<0&&strB.indexOf("fangkuai2")<0){//手牌没有2
					NewB[0].meihua2=0;NewB[0].hongtao2=0;NewB[0].heitao2=0;NewB[0].fangkuai2=0;
				}
				console.log("♠2张数："+NewB[0].heitao2+"；♥2张数："+NewB[0].hongtao2+"；♣2张数："+NewB[0].meihua2+"；♦2张数："+NewB[0].fangkuai2);
				
				console.log("♥A张数："+NewB[0].hongtaoA);
				/*
				var allType={"NewB[0].dawang":0,"NewB[0].xiaowang":0,"NewB[0].heitao2":0,"hongtao2":0,"meihua2":0,"fangkuai2":0,"heitaoA":0,"hongtaoA":0,"meihuaA":0,"fangkuaiA":0,
				"heitaoK":0,"hongtaoK":0,"meihuaK":0,"fangkuaiK":0,"heitaoQ":0,"hongtaoQ":0,"meihuaQ":0,"fangkuaiQ":0,"heitaoJ":0,"hongtaoJ":0,"meihuaJ":0,"fangkuaiJ":0,
				"heitao10":0,"hongtao10":0,"meihua10":0,"fangkuai10":0,"heitao9":0,"hongtao9":0,"meihua9":0,"fangkuai9":0,"heitao8":0,"hongtao8":0,"meihua8":0,"fangkuai8":0,
				"heitao7":0,"hongtao7":0,"meihua7":0,"fangkuai7":0,"heitao6":0,"hongtao6":0,"meihua6":0,"fangkuai6":0,"heitao5":0,"hongtao5":0,"meihua5":0,"fangkuai5":0,
				"heitao4":0,"hongtao4":0,"meihua4":0,"fangkuai4":0,"heitao3":0,"hongtao3":0,"meihua3":0,"fangkuai3":0,};
				...
				for(var key in allType){
					console.log(key+"---:---"+typeof(ReturnType(key)));
					$.each(NewB[0],function() {
					if(typeof(NewB[0])==undefined){
						type=0;
						console.log(key+"的张数：*********************"+type);
					}
					});
					}
					
					console.log("NewB[0].xiaowang="+NewB[0].xiaowang);
					console.log("NewB[0].key="+NewB[0].key); */
				...
				console.log("♠A张数："+NewB[0].heitaoA);
				console.log("♥A张数："+NewB[0].hongtaoA);
				console.log("♣A张数："+NewB[0].meihuaA);
			...
			$(this).click(function(){
			var num=[];
			for(var r=0;r<NewB[0].heitao2;r++){
			num.push("♠2");
			}
